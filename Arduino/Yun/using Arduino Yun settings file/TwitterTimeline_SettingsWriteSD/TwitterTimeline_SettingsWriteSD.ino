/*
  ...
  in this sketch there is a command to put settings file on SD:
   HomeTimelineChoreo.setSettingsFileToWrite("/mnt/sda1/MyTwitterSettings");
   in the next sketch we will
