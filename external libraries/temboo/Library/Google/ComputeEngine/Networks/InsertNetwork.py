...
class InsertNetwork(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(InsertNetwork, self).__init__(temboo_session, '/Library/Google/ComputeEngine/Networks/InsertNetwork')
...
class InsertNetworkInputSet(InputSet):
    ...
    def set_NetworkResource(self, value):
        ...
        """
        super(InsertNetworkInputSet, self)._set_input('NetworkResource', value)
    def set_AccessToken(self, value):
        """
        Set the value of the AccessToken input for this Choreo. ((optional, string) A valid access token retrieved during the OAuth process. This is required unless you provide the ClientID, ClientSecret, and RefreshToken to generate a new access token.)
        """
        super(InsertNetworkInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        """
        Set the value of the ClientID input for this Choreo. ((conditional, string) The Client ID provided by Google. Required unless providing a valid AccessToken.)
        """
        super(InsertNetworkInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        """
        Set the value of the ClientSecret input for this Choreo. ((conditional, string) The Client Secret provided by Google. Required unless providing a valid AccessToken.)
        """
        super(InsertNetworkInputSet, self)._set_input('ClientSecret', value)
    def set_Description(self, value):
        """
        Set the value of the Description input for this Choreo. ((optional, string) A description of the network.)
        """
        super(InsertNetworkInputSet, self)._set_input('Description', value)
    def set_GatewayIP(self, value):
        ...
        """
        super(InsertNetworkInputSet, self)._set_input('GatewayIP', value)
    def set_IPRange(self, value):
        ...
        """
        super(InsertNetworkInputSet, self)._set_input('IPRange', value)
    def set_Name(self, value):
        """
        Set the value of the Name input for this Choreo. ((conditional, string) The name of the network.)
        """
        super(InsertNetworkInputSet, self)._set_input('Name', value)
    def set_Project(self, value):
        """
        Set the value of the Project input for this Choreo. ((required, string) The ID of a Google Compute project.)
        """
        super(InsertNetworkInputSet, self)._set_input('Project', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth refresh token used to generate a new access token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(InsertNetworkInputSet, self)._set_input('RefreshToken', value)
