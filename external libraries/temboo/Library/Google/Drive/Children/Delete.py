...
class Delete(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(Delete, self).__init__(temboo_session, '/Library/Google/Drive/Children/Delete')
...
class DeleteInputSet(InputSet):
    ...
    def set_ChildID(self, value):
        ...
        """
        super(DeleteInputSet, self)._set_input('ChildID', value)
    ...
    def set_FolderID(self, value):
        ...
        """
        super(DeleteInputSet, self)._set_input('FolderID', value)
