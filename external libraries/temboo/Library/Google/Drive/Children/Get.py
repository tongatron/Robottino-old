...
class Get(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(Get, self).__init__(temboo_session, '/Library/Google/Drive/Children/Get')
...
class GetInputSet(InputSet):
    ...
    def set_ChildID(self, value):
        ...
        """
        super(GetInputSet, self)._set_input('ChildID', value)
    ...
    def set_FolderID(self, value):
        ...
        """
        super(GetInputSet, self)._set_input('FolderID', value)
