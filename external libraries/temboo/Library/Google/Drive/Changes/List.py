...
class List(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(List, self).__init__(temboo_session, '/Library/Google/Drive/Changes/List')
...
class ListInputSet(InputSet):
    ...
    def set_IncludeDeleted(self, value):
        ...
        """
        super(ListInputSet, self)._set_input('IncludeDeleted', value)
    def set_IncludeSubscribed(self, value):
        ...
        """
        super(ListInputSet, self)._set_input('IncludeSubscribed', value)
    ...
    def set_StartChangeID(self, value):
        ...
        """
        super(ListInputSet, self)._set_input('StartChangeID', value)
