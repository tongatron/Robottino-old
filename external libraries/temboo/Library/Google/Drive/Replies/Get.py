...
class Get(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(Get, self).__init__(temboo_session, '/Library/Google/Drive/Replies/Get')
...
class GetInputSet(InputSet):
    ...
    def set_CommentID(self, value):
        ...
        """
        super(GetInputSet, self)._set_input('CommentID', value)
    ...
    def set_IncludeDeleted(self, value):
        ...
        """
        super(GetInputSet, self)._set_input('IncludeDeleted', value)
    ...
    def set_ReplyID(self, value):
        ...
        """
        super(GetInputSet, self)._set_input('ReplyID', value)
