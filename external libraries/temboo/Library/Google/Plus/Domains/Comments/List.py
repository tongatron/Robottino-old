...
class List(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(List, self).__init__(temboo_session, '/Library/Google/Plus/Domains/Comments/List')
...
class ListInputSet(InputSet):
    ...
    def set_ActivityID(self, value):
        ...
        """
        super(ListInputSet, self)._set_input('ActivityID', value)
    ...
    def set_OrderBy(self, value):
        ...
        """
        super(ListInputSet, self)._set_input('OrderBy', value)
