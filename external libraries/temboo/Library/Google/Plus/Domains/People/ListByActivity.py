...
class ListByActivity(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListByActivity, self).__init__(temboo_session, '/Library/Google/Plus/Domains/People/ListByActivity')
...
class ListByActivityInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(ListByActivityInputSet, self)._set_input('AccessToken', value)
    def set_ActivityID(self, value):
        ...
        """
        super(ListByActivityInputSet, self)._set_input('ActivityID', value)
    def set_Callback(self, value):
        ...
        """
        super(ListByActivityInputSet, self)._set_input('Callback', value)
    def set_ClientID(self, value):
        """
        Set the value of the ClientID input for this Choreo. ((conditional, string) The Client ID provided by Google. Required unless providing a valid AccessToken.)
        """
        super(ListByActivityInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        """
        Set the value of the ClientSecret input for this Choreo. ((conditional, string) The Client Secret provided by Google. Required unless providing a valid AccessToken.)
        """
        super(ListByActivityInputSet, self)._set_input('ClientSecret', value)
    def set_Collection(self, value):
        ...
        """
        super(ListByActivityInputSet, self)._set_input('Collection', value)
    def set_Fields(self, value):
        ...
        """
        super(ListByActivityInputSet, self)._set_input('Fields', value)
    def set_MaxResults(self, value):
        ...
        """
        super(ListByActivityInputSet, self)._set_input('MaxResults', value)
    def set_OrderBy(self, value):
        ...
        """
        super(ListByActivityInputSet, self)._set_input('OrderBy', value)
    def set_PageToken(self, value):
        ...
        """
        super(ListByActivityInputSet, self)._set_input('PageToken', value)
    def set_PrettyPrint(self, value):
        ...
        """
        super(ListByActivityInputSet, self)._set_input('PrettyPrint', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth Refresh Token used to generate a new access token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(ListByActivityInputSet, self)._set_input('RefreshToken', value)
    def set_UserID(self, value):
        ...
        """
        super(ListByActivityInputSet, self)._set_input('UserID', value)
    def set_UserIP(self, value):
        ...
        """
        super(ListByActivityInputSet, self)._set_input('UserIP', value)
