...
class BadgesByCategory(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(BadgesByCategory, self).__init__(temboo_session, '/Library/KhanAcademy/Badges/BadgesByCategory')
...
class BadgesByCategoryInputSet(InputSet):
    ...
    def set_CategoryID(self, value):
        ...
        """
        super(BadgesByCategoryInputSet, self)._set_input('CategoryID', value)
