...
class GetExerciseLog(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetExerciseLog, self).__init__(temboo_session, '/Library/KhanAcademy/Users/GetExerciseLog')
...
class GetExerciseLogInputSet(InputSet):
    ...
    def set_ConsumerKey(self, value):
        ...
        """
        super(GetExerciseLogInputSet, self)._set_input('ConsumerKey', value)
    def set_ConsumerSecret(self, value):
        ...
        """
        super(GetExerciseLogInputSet, self)._set_input('ConsumerSecret', value)
    def set_Email(self, value):
        ...
        """
        super(GetExerciseLogInputSet, self)._set_input('Email', value)
    def set_EndTime(self, value):
        ...
        """
        super(GetExerciseLogInputSet, self)._set_input('EndTime', value)
    def set_ExerciseName(self, value):
        ...
        """
        super(GetExerciseLogInputSet, self)._set_input('ExerciseName', value)
    def set_OAuthTokenSecret(self, value):
        ...
        """
        super(GetExerciseLogInputSet, self)._set_input('OAuthTokenSecret', value)
    def set_OAuthToken(self, value):
        ...
        """
        super(GetExerciseLogInputSet, self)._set_input('OAuthToken', value)
    def set_StartTime(self, value):
        ...
        """
        super(GetExerciseLogInputSet, self)._set_input('StartTime', value)
