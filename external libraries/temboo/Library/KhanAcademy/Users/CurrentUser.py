...
class CurrentUser(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CurrentUser, self).__init__(temboo_session, '/Library/KhanAcademy/Users/CurrentUser')
...
class CurrentUserInputSet(InputSet):
    ...
    def set_ConsumerKey(self, value):
        ...
        """
        super(CurrentUserInputSet, self)._set_input('ConsumerKey', value)
    def set_ConsumerSecret(self, value):
        ...
        """
        super(CurrentUserInputSet, self)._set_input('ConsumerSecret', value)
    def set_Email(self, value):
        ...
        """
        super(CurrentUserInputSet, self)._set_input('Email', value)
    def set_OAuthTokenSecret(self, value):
        ...
        """
        super(CurrentUserInputSet, self)._set_input('OAuthTokenSecret', value)
    def set_OAuthToken(self, value):
        ...
        """
        super(CurrentUserInputSet, self)._set_input('OAuthToken', value)
