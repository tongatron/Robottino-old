...
class GetVideo(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetVideo, self).__init__(temboo_session, '/Library/KhanAcademy/Users/GetVideo')
...
class GetVideoInputSet(InputSet):
    ...
    def set_ConsumerKey(self, value):
        ...
        """
        super(GetVideoInputSet, self)._set_input('ConsumerKey', value)
    def set_ConsumerSecret(self, value):
        ...
        """
        super(GetVideoInputSet, self)._set_input('ConsumerSecret', value)
    def set_Email(self, value):
        ...
        """
        super(GetVideoInputSet, self)._set_input('Email', value)
    def set_OAuthTokenSecret(self, value):
        ...
        """
        super(GetVideoInputSet, self)._set_input('OAuthTokenSecret', value)
    def set_OAuthToken(self, value):
        ...
        """
        super(GetVideoInputSet, self)._set_input('OAuthToken', value)
    def set_YouTubeID(self, value):
        ...
        """
        super(GetVideoInputSet, self)._set_input('YouTubeID', value)
