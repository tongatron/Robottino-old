...
class GetVideoByReadableID(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetVideoByReadableID, self).__init__(temboo_session, '/Library/KhanAcademy/Videos/GetVideoByReadableID')
...
class GetVideoByReadableIDInputSet(InputSet):
    ...
    def set_ReadableID(self, value):
        ...
        """
        super(GetVideoByReadableIDInputSet, self)._set_input('ReadableID', value)
