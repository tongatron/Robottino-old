...
class GetExerciseVideos(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetExerciseVideos, self).__init__(temboo_session, '/Library/KhanAcademy/Exercises/GetExerciseVideos')
...
class GetExerciseVideosInputSet(InputSet):
    ...
    def set_ExerciseName(self, value):
        ...
        """
        super(GetExerciseVideosInputSet, self)._set_input('ExerciseName', value)
