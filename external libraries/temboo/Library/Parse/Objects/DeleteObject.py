...
class DeleteObject(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteObject, self).__init__(temboo_session, '/Library/Parse/Objects/DeleteObject')
...
class DeleteObjectInputSet(InputSet):
    ...
    def set_ApplicationID(self, value):
        ...
        """
        super(DeleteObjectInputSet, self)._set_input('ApplicationID', value)
    def set_ClassName(self, value):
        ...
        """
        super(DeleteObjectInputSet, self)._set_input('ClassName', value)
    ...
    def set_RESTAPIKey(self, value):
        ...
        """
        super(DeleteObjectInputSet, self)._set_input('RESTAPIKey', value)
