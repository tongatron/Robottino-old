...
class DeleteFile(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteFile, self).__init__(temboo_session, '/Library/Parse/Files/DeleteFile')
...
class DeleteFileInputSet(InputSet):
    ...
    def set_FileName(self, value):
        ...
        """
        super(DeleteFileInputSet, self)._set_input('FileName', value)
    def set_ApplicationID(self, value):
        """
        Set the value of the ApplicationID input for this Choreo. ((required, string) The Application ID provided by Parse.)
        """
        super(DeleteFileInputSet, self)._set_input('ApplicationID', value)
    def set_MasterKey(self, value):
        ...
        """
        super(DeleteFileInputSet, self)._set_input('MasterKey', value)
