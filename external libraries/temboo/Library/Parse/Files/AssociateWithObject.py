...
class AssociateWithObject(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(AssociateWithObject, self).__init__(temboo_session, '/Library/Parse/Files/AssociateWithObject')
...
class AssociateWithObjectInputSet(InputSet):
    ...
    def set_Association(self, value):
        ...
        """
        super(AssociateWithObjectInputSet, self)._set_input('Association', value)
    def set_ApplicationID(self, value):
        """
        Set the value of the ApplicationID input for this Choreo. ((required, string) The Application ID provided by Parse.)
        """
        super(AssociateWithObjectInputSet, self)._set_input('ApplicationID', value)
    def set_ClassName(self, value):
        ...
        """
        super(AssociateWithObjectInputSet, self)._set_input('ClassName', value)
    def set_RESTAPIKey(self, value):
        """
        Set the value of the RESTAPIKey input for this Choreo. ((required, string) The REST API Key provided by Parse.)
        """
        super(AssociateWithObjectInputSet, self)._set_input('RESTAPIKey', value)
