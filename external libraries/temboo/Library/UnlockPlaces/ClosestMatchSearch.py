...
class ClosestMatchSearch(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ClosestMatchSearch, self).__init__(temboo_session, '/Library/UnlockPlaces/ClosestMatchSearch')
...
class ClosestMatchSearchInputSet(InputSet):
    ...
    def set_Format(self, value):
        ...
        """
        super(ClosestMatchSearchInputSet, self)._set_input('Format', value)
    def set_Gazetteer(self, value):
        ...
        """
        super(ClosestMatchSearchInputSet, self)._set_input('Gazetteer', value)
    def set_MaxRows(self, value):
        ...
        """
        super(ClosestMatchSearchInputSet, self)._set_input('MaxRows', value)
    def set_Name(self, value):
        ...
        """
        super(ClosestMatchSearchInputSet, self)._set_input('Name', value)
    def set_StartRow(self, value):
        ...
        """
        super(ClosestMatchSearchInputSet, self)._set_input('StartRow', value)
