...
class NameAndFeatureSearch(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(NameAndFeatureSearch, self).__init__(temboo_session, '/Library/UnlockPlaces/NameAndFeatureSearch')
...
class NameAndFeatureSearchInputSet(InputSet):
    ...
    def set_FeatureType(self, value):
        ...
        """
        super(NameAndFeatureSearchInputSet, self)._set_input('FeatureType', value)
    def set_Format(self, value):
        ...
        """
        super(NameAndFeatureSearchInputSet, self)._set_input('Format', value)
    def set_Gazetteer(self, value):
        ...
        """
        super(NameAndFeatureSearchInputSet, self)._set_input('Gazetteer', value)
    def set_MaxRows(self, value):
        ...
        """
        super(NameAndFeatureSearchInputSet, self)._set_input('MaxRows', value)
    def set_Name(self, value):
        ...
        """
        super(NameAndFeatureSearchInputSet, self)._set_input('Name', value)
    def set_StartRow(self, value):
        ...
        """
        super(NameAndFeatureSearchInputSet, self)._set_input('StartRow', value)
