...
class GetRecord(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetRecord, self).__init__(temboo_session, '/Library/Salesforce/Objects/GetRecord')
...
class GetRecordInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetRecordInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(GetRecordInputSet, self)._set_input('ClientID', value)
    ...
    def set_InstanceName(self, value):
        ...
        """
        super(GetRecordInputSet, self)._set_input('InstanceName', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth Refresh Token used to generate a new access token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(GetRecordInputSet, self)._set_input('RefreshToken', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: json (the default) and xml.)
        """
        super(GetRecordInputSet, self)._set_input('ResponseFormat', value)
    def set_SObjectName(self, value):
        ...
        """
        super(GetRecordInputSet, self)._set_input('SObjectName', value)
