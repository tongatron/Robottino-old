...
class GetResources(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetResources, self).__init__(temboo_session, '/Library/Salesforce/Resources/GetResources')
...
class GetResourcesInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetResourcesInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(GetResourcesInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(GetResourcesInputSet, self)._set_input('ClientSecret', value)
    def set_InstanceName(self, value):
        ...
        """
        super(GetResourcesInputSet, self)._set_input('InstanceName', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth Refresh Token used to generate a new access token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(GetResourcesInputSet, self)._set_input('RefreshToken', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: json (the default) and xml.)
        """
        super(GetResourcesInputSet, self)._set_input('ResponseFormat', value)
    def set_Version(self, value):
        ...
        """
        super(GetResourcesInputSet, self)._set_input('Version', value)
