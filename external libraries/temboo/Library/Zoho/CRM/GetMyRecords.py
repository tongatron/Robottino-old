...
class GetMyRecords(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetMyRecords, self).__init__(temboo_session, '/Library/Zoho/CRM/GetMyRecords')
...
class GetMyRecordsInputSet(InputSet):
    ...
    def set_AuthenticationToken(self, value):
        ...
        """
        super(GetMyRecordsInputSet, self)._set_input('AuthenticationToken', value)
    def set_FromIndex(self, value):
        ...
        """
        super(GetMyRecordsInputSet, self)._set_input('FromIndex', value)
    def set_LastModifiedTime(self, value):
        ...
        """
        super(GetMyRecordsInputSet, self)._set_input('LastModifiedTime', value)
    def set_Module(self, value):
        ...
        """
        super(GetMyRecordsInputSet, self)._set_input('Module', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(GetMyRecordsInputSet, self)._set_input('ResponseFormat', value)
    def set_SelectColumns(self, value):
        ...
        """
        super(GetMyRecordsInputSet, self)._set_input('SelectColumns', value)
    def set_SortColumnString(self, value):
        ...
        """
        super(GetMyRecordsInputSet, self)._set_input('SortColumnString', value)
    def set_SortOrderString(self, value):
        ...
        """
        super(GetMyRecordsInputSet, self)._set_input('SortOrderString', value)
    def set_ToIndex(self, value):
        ...
        """
        super(GetMyRecordsInputSet, self)._set_input('ToIndex', value)
