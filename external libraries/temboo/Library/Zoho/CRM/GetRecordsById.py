...
class GetRecordsById(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetRecordsById, self).__init__(temboo_session, '/Library/Zoho/CRM/GetRecordsById')
...
class GetRecordsByIdInputSet(InputSet):
    ...
    def set_AuthenticationToken(self, value):
        ...
        """
        super(GetRecordsByIdInputSet, self)._set_input('AuthenticationToken', value)
    def set_ID(self, value):
        """
        Set the value of the ID input for this Choreo. ((required, integer) The ID for the Zoho record to lookup)
        """
        super(GetRecordsByIdInputSet, self)._set_input('ID', value)
    def set_Module(self, value):
        ...
        """
        super(GetRecordsByIdInputSet, self)._set_input('Module', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(GetRecordsByIdInputSet, self)._set_input('ResponseFormat', value)
