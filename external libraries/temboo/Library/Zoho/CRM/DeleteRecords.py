...
class DeleteRecords(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteRecords, self).__init__(temboo_session, '/Library/Zoho/CRM/DeleteRecords')
...
class DeleteRecordsInputSet(InputSet):
    ...
    def set_AuthenticationToken(self, value):
        ...
        """
        super(DeleteRecordsInputSet, self)._set_input('AuthenticationToken', value)
    def set_ID(self, value):
        """
        Set the value of the ID input for this Choreo. ((required, integer) The ID for the record you want to delete)
        """
        super(DeleteRecordsInputSet, self)._set_input('ID', value)
    def set_Module(self, value):
        ...
        """
        super(DeleteRecordsInputSet, self)._set_input('Module', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(DeleteRecordsInputSet, self)._set_input('ResponseFormat', value)
