...
class ListSharedDocuments(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListSharedDocuments, self).__init__(temboo_session, '/Library/Zoho/Writer/ListSharedDocuments')
...
class ListSharedDocumentsInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ListSharedDocumentsInputSet, self)._set_input('APIKey', value)
    def set_Limit(self, value):
        """
        Set the value of the Limit input for this Choreo. ((optional, integer) Sets the number of documents to be listed.)
        """
        super(ListSharedDocumentsInputSet, self)._set_input('Limit', value)
    def set_LoginID(self, value):
        ...
        """
        super(ListSharedDocumentsInputSet, self)._set_input('LoginID', value)
    def set_OrderBy(self, value):
        ...
        """
        super(ListSharedDocumentsInputSet, self)._set_input('OrderBy', value)
    def set_Password(self, value):
        """
        Set the value of the Password input for this Choreo. ((required, password) Your Zoho password)
        """
        super(ListSharedDocumentsInputSet, self)._set_input('Password', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(ListSharedDocumentsInputSet, self)._set_input('ResponseFormat', value)
    def set_SortOrder(self, value):
        ...
        """
        super(ListSharedDocumentsInputSet, self)._set_input('SortOrder', value)
    def set_StartFrom(self, value):
        ...
        """
        super(ListSharedDocumentsInputSet, self)._set_input('StartFrom', value)
