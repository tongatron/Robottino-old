...
class Batch(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(Batch, self).__init__(temboo_session, '/Library/Facebook/BatchRequests/Batch')
...
class BatchInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(BatchInputSet, self)._set_input('AccessToken', value)
    def set_Batch(self, value):
        ...
        """
        super(BatchInputSet, self)._set_input('Batch', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.)
        """
        super(BatchInputSet, self)._set_input('ResponseFormat', value)
