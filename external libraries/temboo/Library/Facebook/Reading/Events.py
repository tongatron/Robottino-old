...
class Events(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(Events, self).__init__(temboo_session, '/Library/Facebook/Reading/Events')
...
class EventsInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(EventsInputSet, self)._set_input('AccessToken', value)
    def set_Fields(self, value):
        """
        Set the value of the Fields input for this Choreo. ((optional, string) A comma separated list of fields to return (i.e. id,name).)
        """
        super(EventsInputSet, self)._set_input('Fields', value)
    def set_Limit(self, value):
        ...
        """
        super(EventsInputSet, self)._set_input('Limit', value)
    def set_Offset(self, value):
        """
        Set the value of the Offset input for this Choreo. ((optional, integer) Used to page through results. Returns results starting from the specified number.)
        """
        super(EventsInputSet, self)._set_input('Offset', value)
    def set_ProfileID(self, value):
        ...
        """
        super(EventsInputSet, self)._set_input('ProfileID', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.)
        """
        super(EventsInputSet, self)._set_input('ResponseFormat', value)
    def set_Since(self, value):
        ...
        """
        super(EventsInputSet, self)._set_input('Since', value)
    def set_Until(self, value):
        ...
        """
        super(EventsInputSet, self)._set_input('Until', value)
