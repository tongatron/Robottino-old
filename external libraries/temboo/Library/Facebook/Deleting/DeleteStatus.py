...
class DeleteStatus(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteStatus, self).__init__(temboo_session, '/Library/Facebook/Deleting/DeleteStatus')
...
class DeleteStatusInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(DeleteStatusInputSet, self)._set_input('AccessToken', value)
    def set_StatusID(self, value):
        ...
        """
        super(DeleteStatusInputSet, self)._set_input('StatusID', value)
