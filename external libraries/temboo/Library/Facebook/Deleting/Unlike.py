...
class Unlike(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(Unlike, self).__init__(temboo_session, '/Library/Facebook/Deleting/Unlike')
