...
class DeletePublication(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeletePublication, self).__init__(temboo_session, '/Library/Facebook/Actions/News/Publishes/DeletePublication')
...
class DeletePublicationInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(DeletePublicationInputSet, self)._set_input('AccessToken', value)
    def set_ActionID(self, value):
        """
        Set the value of the ActionID input for this Choreo. ((required, string) The id of an action to delete.)
        """
        super(DeletePublicationInputSet, self)._set_input('ActionID', value)
