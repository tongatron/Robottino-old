...
class CreateRating(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CreateRating, self).__init__(temboo_session, '/Library/Facebook/Actions/Video/Rates/CreateRating')
...
class CreateRatingInputSet(InputSet):
    ...
    def set_Episode(self, value):
        ...
        """
        super(CreateRatingInputSet, self)._set_input('Episode', value)
    ...
    def set_Movie(self, value):
        ...
        """
        super(CreateRatingInputSet, self)._set_input('Movie', value)
    ...
    def set_Other(self, value):
        ...
        """
        super(CreateRatingInputSet, self)._set_input('Other', value)
    ...
    def set_TVShow(self, value):
        ...
        """
        super(CreateRatingInputSet, self)._set_input('TVShow', value)
