...
class DeleteBike(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteBike, self).__init__(temboo_session, '/Library/Facebook/Actions/Fitness/Bikes/DeleteBike')
...
class DeleteBikeInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(DeleteBikeInputSet, self)._set_input('AccessToken', value)
    def set_ActionID(self, value):
        """
        Set the value of the ActionID input for this Choreo. ((required, string) The id of an action to delete.)
        """
        super(DeleteBikeInputSet, self)._set_input('ActionID', value)
