...
class UpdateFollow(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(UpdateFollow, self).__init__(temboo_session, '/Library/Facebook/Actions/General/Follows/UpdateFollow')
...
class UpdateFollowInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(UpdateFollowInputSet, self)._set_input('AccessToken', value)
    def set_ActionID(self, value):
        """
        Set the value of the ActionID input for this Choreo. ((required, string) The id of the action to update.)
        """
        super(UpdateFollowInputSet, self)._set_input('ActionID', value)
    def set_EndTime(self, value):
        ...
        """
        super(UpdateFollowInputSet, self)._set_input('EndTime', value)
    def set_ExpiresIn(self, value):
        ...
        """
        super(UpdateFollowInputSet, self)._set_input('ExpiresIn', value)
    def set_Message(self, value):
        ...
        """
        super(UpdateFollowInputSet, self)._set_input('Message', value)
    def set_Place(self, value):
        ...
        """
        super(UpdateFollowInputSet, self)._set_input('Place', value)
    def set_Profile(self, value):
        ...
        """
        super(UpdateFollowInputSet, self)._set_input('Profile', value)
    def set_Tags(self, value):
        ...
        """
        super(UpdateFollowInputSet, self)._set_input('Tags', value)
