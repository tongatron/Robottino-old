...
class DeleteFollow(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteFollow, self).__init__(temboo_session, '/Library/Facebook/Actions/General/Follows/DeleteFollow')
...
class DeleteFollowInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(DeleteFollowInputSet, self)._set_input('AccessToken', value)
    def set_ActionID(self, value):
        """
        Set the value of the ActionID input for this Choreo. ((required, string) The id of an action to delete.)
        """
        super(DeleteFollowInputSet, self)._set_input('ActionID', value)
