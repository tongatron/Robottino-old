...
class UpdateRating(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(UpdateRating, self).__init__(temboo_session, '/Library/Facebook/Actions/Books/Rates/UpdateRating')
...
class UpdateRatingInputSet(InputSet):
    ...
    def set_Book(self, value):
        ...
        """
        super(UpdateRatingInputSet, self)._set_input('Book', value)
