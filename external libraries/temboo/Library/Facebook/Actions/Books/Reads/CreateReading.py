...
class CreateReading(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CreateReading, self).__init__(temboo_session, '/Library/Facebook/Actions/Books/Reads/CreateReading')
...
class CreateReadingInputSet(InputSet):
    ...
    def set_Book(self, value):
        ...
        """
        super(CreateReadingInputSet, self)._set_input('Book', value)
    ...
    def set_ProgressPercentComplete(self, value):
        ...
        """
        super(CreateReadingInputSet, self)._set_input('ProgressPercentComplete', value)
    def set_ProgressTimestamp(self, value):
        ...
        """
        super(CreateReadingInputSet, self)._set_input('ProgressTimestamp', value)
