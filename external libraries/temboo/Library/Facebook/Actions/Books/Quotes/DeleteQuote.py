...
class DeleteQuote(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteQuote, self).__init__(temboo_session, '/Library/Facebook/Actions/Books/Quotes/DeleteQuote')
...
class DeleteQuoteInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(DeleteQuoteInputSet, self)._set_input('AccessToken', value)
    def set_ActionID(self, value):
        """
        Set the value of the ActionID input for this Choreo. ((required, string) The id of an action to delete.)
        """
        super(DeleteQuoteInputSet, self)._set_input('ActionID', value)
