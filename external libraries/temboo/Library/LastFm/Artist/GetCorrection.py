...
class GetCorrection(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetCorrection, self).__init__(temboo_session, '/Library/LastFm/Artist/GetCorrection')
...
class GetCorrectionInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(GetCorrectionInputSet, self)._set_input('APIKey', value)
    def set_Artist(self, value):
        """
        Set the value of the Artist input for this Choreo. ((string) The artist name to correct.)
        """
        super(GetCorrectionInputSet, self)._set_input('Artist', value)
