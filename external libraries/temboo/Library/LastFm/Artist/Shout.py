...
class Shout(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(Shout, self).__init__(temboo_session, '/Library/LastFm/Artist/Shout')
...
class ShoutInputSet(InputSet):
    ...
    def set_Message(self, value):
        ...
        """
        super(ShoutInputSet, self)._set_input('Message', value)
    def set_SessionKey(self, value):
        ...
        """
        super(ShoutInputSet, self)._set_input('SessionKey', value)
