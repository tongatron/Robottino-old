...
class GetPodcast(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetPodcast, self).__init__(temboo_session, '/Library/LastFm/Artist/GetPodcast')
...
class GetPodcastInputSet(InputSet):
    ...
    def set_AutoCorrect(self, value):
        ...
        """
        super(GetPodcastInputSet, self)._set_input('AutoCorrect', value)
    def set_MbID(self, value):
        ...
        """
        super(GetPodcastInputSet, self)._set_input('MbID', value)
