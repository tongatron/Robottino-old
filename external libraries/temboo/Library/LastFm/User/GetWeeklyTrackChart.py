...
class GetWeeklyTrackChart(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetWeeklyTrackChart, self).__init__(temboo_session, '/Library/LastFm/User/GetWeeklyTrackChart')
...
class GetWeeklyTrackChartInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(GetWeeklyTrackChartInputSet, self)._set_input('APIKey', value)
    def set_EndTimestamp(self, value):
        ...
        """
        super(GetWeeklyTrackChartInputSet, self)._set_input('EndTimestamp', value)
    def set_StartTimestamp(self, value):
        ...
        """
        super(GetWeeklyTrackChartInputSet, self)._set_input('StartTimestamp', value)
    def set_User(self, value):
        """
        Set the value of the User input for this Choreo. ((string) The last.fm username to fetch the charts of.)
        """
        super(GetWeeklyTrackChartInputSet, self)._set_input('User', value)
