...
class GetPlaylists(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetPlaylists, self).__init__(temboo_session, '/Library/LastFm/User/GetPlaylists')
