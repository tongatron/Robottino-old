...
class CompareUsers(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CompareUsers, self).__init__(temboo_session, '/Library/LastFm/Tasteometer/CompareUsers')
