...
class GetAnalyticsByType(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetAnalyticsByType, self).__init__(temboo_session, '/Library/Clicky/GetAnalyticsByType')
...
class GetAnalyticsByTypeInputSet(InputSet):
    ...
    def set_Limit(self, value):
        ...
        """
        super(GetAnalyticsByTypeInputSet, self)._set_input('Limit', value)
    def set_Output(self, value):
        ...
        """
        super(GetAnalyticsByTypeInputSet, self)._set_input('Output', value)
    def set_SiteID(self, value):
        ...
        """
        super(GetAnalyticsByTypeInputSet, self)._set_input('SiteID', value)
    def set_SiteKey(self, value):
        ...
        """
        super(GetAnalyticsByTypeInputSet, self)._set_input('SiteKey', value)
    def set_Type(self, value):
        ...
        """
        super(GetAnalyticsByTypeInputSet, self)._set_input('Type', value)
