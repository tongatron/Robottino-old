...
class FilterByItems(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(FilterByItems, self).__init__(temboo_session, '/Library/Clicky/FilterByItems')
...
class FilterByItemsInputSet(InputSet):
    ...
    def set_Item(self, value):
        ...
        """
        super(FilterByItemsInputSet, self)._set_input('Item', value)
    def set_Limit(self, value):
        ...
        """
        super(FilterByItemsInputSet, self)._set_input('Limit', value)
    def set_Output(self, value):
        ...
        """
        super(FilterByItemsInputSet, self)._set_input('Output', value)
    def set_SiteID(self, value):
        ...
        """
        super(FilterByItemsInputSet, self)._set_input('SiteID', value)
    def set_SiteKey(self, value):
        ...
        """
        super(FilterByItemsInputSet, self)._set_input('SiteKey', value)
    def set_Type(self, value):
        ...
        """
        super(FilterByItemsInputSet, self)._set_input('Type', value)
