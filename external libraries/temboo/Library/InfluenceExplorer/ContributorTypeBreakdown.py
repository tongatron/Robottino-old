...
class ContributorTypeBreakdown(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ContributorTypeBreakdown, self).__init__(temboo_session, '/Library/InfluenceExplorer/ContributorTypeBreakdown')
...
class ContributorTypeBreakdownInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ContributorTypeBreakdownInputSet, self)._set_input('APIKey', value)
    def set_EntityID(self, value):
        ...
        """
        super(ContributorTypeBreakdownInputSet, self)._set_input('EntityID', value)
