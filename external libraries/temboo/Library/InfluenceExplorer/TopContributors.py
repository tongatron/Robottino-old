...
class TopContributors(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(TopContributors, self).__init__(temboo_session, '/Library/InfluenceExplorer/TopContributors')
...
class TopContributorsInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(TopContributorsInputSet, self)._set_input('APIKey', value)
    def set_EntityID(self, value):
        ...
        """
        super(TopContributorsInputSet, self)._set_input('EntityID', value)
