...
class TopRecipients(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(TopRecipients, self).__init__(temboo_session, '/Library/InfluenceExplorer/TopRecipients')
...
class TopRecipientsInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(TopRecipientsInputSet, self)._set_input('APIKey', value)
    def set_EntityID(self, value):
        ...
        """
        super(TopRecipientsInputSet, self)._set_input('EntityID', value)
    def set_Limit(self, value):
        """
        Set the value of the Limit input for this Choreo. ((optional, integer) The number of resutls to return.)
        """
        super(TopRecipientsInputSet, self)._set_input('Limit', value)
