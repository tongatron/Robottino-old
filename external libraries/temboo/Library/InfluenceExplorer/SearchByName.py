...
class SearchByName(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(SearchByName, self).__init__(temboo_session, '/Library/InfluenceExplorer/SearchByName')
...
class SearchByNameInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(SearchByNameInputSet, self)._set_input('APIKey', value)
    def set_Search(self, value):
        """
        Set the value of the Search input for this Choreo. ((required, string) The query string.)
        """
        super(SearchByNameInputSet, self)._set_input('Search', value)
