...
class CreateAccount(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CreateAccount, self).__init__(temboo_session, '/Library/Twilio/Accounts/CreateAccount')
...
class CreateAccountInputSet(InputSet):
    ...
    def set_AccountSID(self, value):
        ...
        """
        super(CreateAccountInputSet, self)._set_input('AccountSID', value)
    def set_AuthToken(self, value):
        """
        Set the value of the AuthToken input for this Choreo. ((required, string) The authorization token provided by Twilio.)
        """
        super(CreateAccountInputSet, self)._set_input('AuthToken', value)
    def set_FriendlyName(self, value):
        ...
        """
        super(CreateAccountInputSet, self)._set_input('FriendlyName', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are json (the default) and xml.)
        """
        super(CreateAccountInputSet, self)._set_input('ResponseFormat', value)
