...
class AddPhoneNumber(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(AddPhoneNumber, self).__init__(temboo_session, '/Library/Twilio/IncomingPhoneNumbers/AddPhoneNumber')
...
class AddPhoneNumberInputSet(InputSet):
    ...
    def set_APIVersion(self, value):
        ...
        """
        super(AddPhoneNumberInputSet, self)._set_input('APIVersion', value)
    def set_AccountSID(self, value):
        """
        Set the value of the AccountSID input for this Choreo. ((required, string) The AccountSID provided when you signed up for a Twilio account.)
        """
        super(AddPhoneNumberInputSet, self)._set_input('AccountSID', value)
    def set_AreaCode(self, value):
        ...
        """
        super(AddPhoneNumberInputSet, self)._set_input('AreaCode', value)
    def set_AuthToken(self, value):
        """
        Set the value of the AuthToken input for this Choreo. ((required, string) The authorization token provided when you signed up for a Twilio account.)
        """
        super(AddPhoneNumberInputSet, self)._set_input('AuthToken', value)
    def set_FriendlyName(self, value):
        ...
        """
        super(AddPhoneNumberInputSet, self)._set_input('FriendlyName', value)
    def set_PhoneNumber(self, value):
        ...
        """
        super(AddPhoneNumberInputSet, self)._set_input('PhoneNumber', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: json (the default) and xml.)
        """
        super(AddPhoneNumberInputSet, self)._set_input('ResponseFormat', value)
    def set_SmsApplicationSID(self, value):
        ...
        """
        super(AddPhoneNumberInputSet, self)._set_input('SmsApplicationSID', value)
    def set_SmsFallbackMethod(self, value):
        ...
        """
        super(AddPhoneNumberInputSet, self)._set_input('SmsFallbackMethod', value)
    def set_SmsFallbackURL(self, value):
        ...
        """
        super(AddPhoneNumberInputSet, self)._set_input('SmsFallbackURL', value)
    def set_SmsMethod(self, value):
        ...
        """
        super(AddPhoneNumberInputSet, self)._set_input('SmsMethod', value)
    def set_SmsURL(self, value):
        ...
        """
        super(AddPhoneNumberInputSet, self)._set_input('SmsURL', value)
    def set_StatusCallbackMethod(self, value):
        ...
        """
        super(AddPhoneNumberInputSet, self)._set_input('StatusCallbackMethod', value)
    def set_StatusCallback(self, value):
        ...
        """
        super(AddPhoneNumberInputSet, self)._set_input('StatusCallback', value)
    def set_SubAccountSID(self, value):
        ...
        """
        super(AddPhoneNumberInputSet, self)._set_input('SubAccountSID', value)
    def set_VoiceApplicationSID(self, value):
        ...
        """
        super(AddPhoneNumberInputSet, self)._set_input('VoiceApplicationSID', value)
    def set_VoiceCallerIDLookup(self, value):
        ...
        """
        super(AddPhoneNumberInputSet, self)._set_input('VoiceCallerIDLookup', value)
    def set_VoiceFallbackMethod(self, value):
        ...
        """
        super(AddPhoneNumberInputSet, self)._set_input('VoiceFallbackMethod', value)
    def set_VoiceFallbackURL(self, value):
        ...
        """
        super(AddPhoneNumberInputSet, self)._set_input('VoiceFallbackURL', value)
    def set_VoiceMethod(self, value):
        ...
        """
        super(AddPhoneNumberInputSet, self)._set_input('VoiceMethod', value)
    def set_VoiceURL(self, value):
        ...
        """
        super(AddPhoneNumberInputSet, self)._set_input('VoiceURL', value)
