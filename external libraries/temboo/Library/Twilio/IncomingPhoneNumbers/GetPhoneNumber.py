...
class GetPhoneNumber(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetPhoneNumber, self).__init__(temboo_session, '/Library/Twilio/IncomingPhoneNumbers/GetPhoneNumber')
...
class GetPhoneNumberInputSet(InputSet):
    ...
    def set_AccountSID(self, value):
        ...
        """
        super(GetPhoneNumberInputSet, self)._set_input('AccountSID', value)
    def set_AuthToken(self, value):
        """
        Set the value of the AuthToken input for this Choreo. ((required, string) The authorization token provided when you signed up for a Twilio account.)
        """
        super(GetPhoneNumberInputSet, self)._set_input('AuthToken', value)
    def set_IncomingPhoneNumberSID(self, value):
        ...
        """
        super(GetPhoneNumberInputSet, self)._set_input('IncomingPhoneNumberSID', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: json (the default) and xml.)
        """
        super(GetPhoneNumberInputSet, self)._set_input('ResponseFormat', value)
    def set_SubAccountSID(self, value):
        ...
        """
        super(GetPhoneNumberInputSet, self)._set_input('SubAccountSID', value)
