...
class DeleteRecording(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteRecording, self).__init__(temboo_session, '/Library/Twilio/Recordings/DeleteRecording')
...
class DeleteRecordingInputSet(InputSet):
    ...
    def set_AccountSID(self, value):
        ...
        """
        super(DeleteRecordingInputSet, self)._set_input('AccountSID', value)
    def set_AuthToken(self, value):
        """
        Set the value of the AuthToken input for this Choreo. ((required, string) The authorization token provided when you signed up for a Twilio account.)
        """
        super(DeleteRecordingInputSet, self)._set_input('AuthToken', value)
    def set_RecordingSID(self, value):
        ...
        """
        super(DeleteRecordingInputSet, self)._set_input('RecordingSID', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: json (the default), and xml.)
        """
        super(DeleteRecordingInputSet, self)._set_input('ResponseFormat', value)
    def set_SubAccountSID(self, value):
        ...
        """
        super(DeleteRecordingInputSet, self)._set_input('SubAccountSID', value)
