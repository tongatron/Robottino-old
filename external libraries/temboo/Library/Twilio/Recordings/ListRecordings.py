...
class ListRecordings(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListRecordings, self).__init__(temboo_session, '/Library/Twilio/Recordings/ListRecordings')
...
class ListRecordingsInputSet(InputSet):
    ...
    def set_AccountSID(self, value):
        ...
        """
        super(ListRecordingsInputSet, self)._set_input('AccountSID', value)
    def set_AuthToken(self, value):
        """
        Set the value of the AuthToken input for this Choreo. ((required, string) The authorization token provided when you signed up for a Twilio account.)
        """
        super(ListRecordingsInputSet, self)._set_input('AuthToken', value)
    def set_PageSize(self, value):
        """
        Set the value of the PageSize input for this Choreo. ((optional, integer) The number of results per page.)
        """
        super(ListRecordingsInputSet, self)._set_input('PageSize', value)
    def set_Page(self, value):
        """
        Set the value of the Page input for this Choreo. ((optional, integer) The page of results to retrieve. Defaults to 0.)
        """
        super(ListRecordingsInputSet, self)._set_input('Page', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: json (the default) and xml.)
        """
        super(ListRecordingsInputSet, self)._set_input('ResponseFormat', value)
    def set_SubAccountSID(self, value):
        ...
        """
        super(ListRecordingsInputSet, self)._set_input('SubAccountSID', value)
