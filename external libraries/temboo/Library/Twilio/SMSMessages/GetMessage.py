...
class GetMessage(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetMessage, self).__init__(temboo_session, '/Library/Twilio/SMSMessages/GetMessage')
...
class GetMessageInputSet(InputSet):
    ...
    def set_AccountSID(self, value):
        ...
        """
        super(GetMessageInputSet, self)._set_input('AccountSID', value)
    def set_AuthToken(self, value):
        """
        Set the value of the AuthToken input for this Choreo. ((required, string) The authorization token provided when you signed up for a Twilio account.)
        """
        super(GetMessageInputSet, self)._set_input('AuthToken', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: json (the default) and xml.)
        """
        super(GetMessageInputSet, self)._set_input('ResponseFormat', value)
    def set_SMSMessageSID(self, value):
        ...
        """
        super(GetMessageInputSet, self)._set_input('SMSMessageSID', value)
    def set_SubAccountSID(self, value):
        ...
        """
        super(GetMessageInputSet, self)._set_input('SubAccountSID', value)
