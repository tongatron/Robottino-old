...
class ListQueues(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListQueues, self).__init__(temboo_session, '/Library/Twilio/Queues/ListQueues')
...
class ListQueuesInputSet(InputSet):
    ...
    def set_SubAccountSID(self, value):
        ...
        """
        super(ListQueuesInputSet, self)._set_input('SubAccountSID', value)
