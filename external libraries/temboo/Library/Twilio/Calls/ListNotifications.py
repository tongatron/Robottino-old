...
class ListNotifications(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListNotifications, self).__init__(temboo_session, '/Library/Twilio/Calls/ListNotifications')
...
class ListNotificationsInputSet(InputSet):
    ...
    def set_CallSID(self, value):
        ...
        """
        super(ListNotificationsInputSet, self)._set_input('CallSID', value)
