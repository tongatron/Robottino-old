...
class ObjectSet(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ObjectSet, self).__init__(temboo_session, '/Library/CloudMine/ObjectStorage/ObjectSet')
...
class ObjectSetInputSet(InputSet):
    ...
    def set_Data(self, value):
        ...
        """
        super(ObjectSetInputSet, self)._set_input('Data', value)
    def set_APIKey(self, value):
        ...
        """
        super(ObjectSetInputSet, self)._set_input('APIKey', value)
    def set_ApplicationIdentifier(self, value):
        ...
        """
        super(ObjectSetInputSet, self)._set_input('ApplicationIdentifier', value)
    def set_SessionToken(self, value):
        ...
        """
        super(ObjectSetInputSet, self)._set_input('SessionToken', value)
