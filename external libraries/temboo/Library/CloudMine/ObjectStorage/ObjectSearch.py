...
class ObjectSearch(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ObjectSearch, self).__init__(temboo_session, '/Library/CloudMine/ObjectStorage/ObjectSearch')
...
class ObjectSearchInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ObjectSearchInputSet, self)._set_input('APIKey', value)
    def set_ApplicationIdentifier(self, value):
        ...
        """
        super(ObjectSearchInputSet, self)._set_input('ApplicationIdentifier', value)
    def set_Count(self, value):
        ...
        """
        super(ObjectSearchInputSet, self)._set_input('Count', value)
    def set_Limit(self, value):
        ...
        """
        super(ObjectSearchInputSet, self)._set_input('Limit', value)
    def set_Query(self, value):
        ...
        """
        super(ObjectSearchInputSet, self)._set_input('Query', value)
    def set_SessionToken(self, value):
        ...
        """
        super(ObjectSearchInputSet, self)._set_input('SessionToken', value)
    def set_Skip(self, value):
        ...
        """
        super(ObjectSearchInputSet, self)._set_input('Skip', value)
