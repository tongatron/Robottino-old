...
class AccountLogin(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(AccountLogin, self).__init__(temboo_session, '/Library/CloudMine/UserAccountManagement/AccountLogin')
...
class AccountLoginInputSet(InputSet):
    ...
    def set_ApplicationIdentifier(self, value):
        ...
        """
        super(AccountLoginInputSet, self)._set_input('ApplicationIdentifier', value)
