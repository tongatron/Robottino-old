...
class GetUsers(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetUsers, self).__init__(temboo_session, '/Library/CloudMine/UserAccountManagement/GetUsers')
...
class GetUsersInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(GetUsersInputSet, self)._set_input('APIKey', value)
    def set_ApplicationIdentifier(self, value):
        ...
        """
        super(GetUsersInputSet, self)._set_input('ApplicationIdentifier', value)
