...
class StarGist(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(StarGist, self).__init__(temboo_session, '/Library/GitHub/GistsAPI/Gists/StarGist')
...
class StarGistInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(StarGistInputSet, self)._set_input('AccessToken', value)
    def set_ID(self, value):
        """
        Set the value of the ID input for this Choreo. ((required, string) The id for the gist you want to star.)
        """
        super(StarGistInputSet, self)._set_input('ID', value)
