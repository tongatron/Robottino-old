...
class DeleteGist(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteGist, self).__init__(temboo_session, '/Library/GitHub/GistsAPI/Gists/DeleteGist')
...
class DeleteGistInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(DeleteGistInputSet, self)._set_input('AccessToken', value)
    def set_ID(self, value):
        """
        Set the value of the ID input for this Choreo. ((required, string) The id for the gist you want to delete.)
        """
        super(DeleteGistInputSet, self)._set_input('ID', value)
