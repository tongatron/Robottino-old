...
class CreateComment(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CreateComment, self).__init__(temboo_session, '/Library/GitHub/GistsAPI/Comments/CreateComment')
