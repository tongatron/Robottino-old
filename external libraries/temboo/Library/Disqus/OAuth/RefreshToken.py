...
class RefreshToken(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(RefreshToken, self).__init__(temboo_session, '/Library/Disqus/OAuth/RefreshToken')
...
class RefreshTokenInputSet(InputSet):
    ...
    def set_PublicKey(self, value):
        ...
        """
        super(RefreshTokenInputSet, self)._set_input('PublicKey', value)
    ...
    def set_SecretKey(self, value):
        ...
        """
        super(RefreshTokenInputSet, self)._set_input('SecretKey', value)
