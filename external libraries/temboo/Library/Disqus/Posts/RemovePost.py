...
class RemovePost(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(RemovePost, self).__init__(temboo_session, '/Library/Disqus/Posts/RemovePost')
...
class RemovePostInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(RemovePostInputSet, self)._set_input('AccessToken', value)
    def set_PostID(self, value):
        ...
        """
        super(RemovePostInputSet, self)._set_input('PostID', value)
    def set_PublicKey(self, value):
        """
        Set the value of the PublicKey input for this Choreo. ((required, string) The Public Key provided by Disqus (AKA the API Key).)
        """
        super(RemovePostInputSet, self)._set_input('PublicKey', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(RemovePostInputSet, self)._set_input('ResponseFormat', value)
