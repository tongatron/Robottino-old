...
class RemoveModerator(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(RemoveModerator, self).__init__(temboo_session, '/Library/Disqus/Forums/RemoveModerator')


    def new_input_set(self):
        return RemoveModeratorInputSet()

    def _make_result_set(self, result, path):
        return RemoveModeratorResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return RemoveModeratorChoreographyExecution(session, exec_id, path)

class RemoveModeratorInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(RemoveModeratorInputSet, self)._set_input('AccessToken', value)
    def set_ModeratorID(self, value):
        """
        Set the value of the ModeratorID input for this Choreo. ((required, string) Moderator ID)
        """
        super(RemoveModeratorInputSet, self)._set_input('ModeratorID', value)
    def set_PublicKey(self, value):
        """
        Set the value of the PublicKey input for this Choreo. ((required, string) The Public Key provided by Disqus (AKA the API Key).)
        """
        super(RemoveModeratorInputSet, self)._set_input('PublicKey', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(RemoveModeratorInputSet, self)._set_input('ResponseFormat', value)

class RemoveModeratorResultSet(ResultSet):
    """
...
class RemoveModeratorChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return RemoveModeratorResultSet(response, path)
