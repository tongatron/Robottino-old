...
class GetForumDetails(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetForumDetails, self).__init__(temboo_session, '/Library/Disqus/Forums/GetForumDetails')


    def new_input_set(self):
        return GetForumDetailsInputSet()

    def _make_result_set(self, result, path):
        return GetForumDetailsResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetForumDetailsChoreographyExecution(session, exec_id, path)

class GetForumDetailsInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetForumDetailsInputSet, self)._set_input('AccessToken', value)
    def set_Forum(self, value):
        ...
        """
        super(GetForumDetailsInputSet, self)._set_input('Forum', value)
    def set_PublicKey(self, value):
        """
        Set the value of the PublicKey input for this Choreo. ((required, string) The Public Key provided by Disqus (AKA the API Key).)
        """
        super(GetForumDetailsInputSet, self)._set_input('PublicKey', value)
    def set_Related(self, value):
        ...
        """
        super(GetForumDetailsInputSet, self)._set_input('Related', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(GetForumDetailsInputSet, self)._set_input('ResponseFormat', value)

class GetForumDetailsResultSet(ResultSet):
    """
...
class GetForumDetailsChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return GetForumDetailsResultSet(response, path)
