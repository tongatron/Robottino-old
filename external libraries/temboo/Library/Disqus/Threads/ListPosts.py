...
class ListPosts(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListPosts, self).__init__(temboo_session, '/Library/Disqus/Threads/ListPosts')
...
class ListPostsInputSet(InputSet):
    ...
    def set_ThreadIdentifier(self, value):
        ...
        """
        super(ListPostsInputSet, self)._set_input('ThreadIdentifier', value)
    def set_ThreadLink(self, value):
        ...
        """
        super(ListPostsInputSet, self)._set_input('ThreadLink', value)
