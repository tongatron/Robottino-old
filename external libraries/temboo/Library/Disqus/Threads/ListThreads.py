...
class ListThreads(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListThreads, self).__init__(temboo_session, '/Library/Disqus/Threads/ListThreads')
...
class ListThreadsInputSet(InputSet):
    ...
    def set_AuthorID(self, value):
        ...
        """
        super(ListThreadsInputSet, self)._set_input('AuthorID', value)
    def set_AuthorUsername(self, value):
        ...
        """
        super(ListThreadsInputSet, self)._set_input('AuthorUsername', value)
    def set_Category(self, value):
        ...
        """
        super(ListThreadsInputSet, self)._set_input('Category', value)
    ...
    def set_Since(self, value):
        ...
        """
        super(ListThreadsInputSet, self)._set_input('Since', value)
