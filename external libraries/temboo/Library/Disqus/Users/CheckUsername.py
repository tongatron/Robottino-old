...
class CheckUsername(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CheckUsername, self).__init__(temboo_session, '/Library/Disqus/Users/CheckUsername')
...
class CheckUsernameInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(CheckUsernameInputSet, self)._set_input('AccessToken', value)
    def set_Callback(self, value):
        ...
        """
        super(CheckUsernameInputSet, self)._set_input('Callback', value)
    def set_PublicKey(self, value):
        """
        Set the value of the PublicKey input for this Choreo. ((required, string) The Public Key provided by Disqus (AKA the API Key).)
        """
        super(CheckUsernameInputSet, self)._set_input('PublicKey', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(CheckUsernameInputSet, self)._set_input('ResponseFormat', value)
    def set_Username(self, value):
        """
        Set the value of the Username input for this Choreo. ((required, string) Enter a Disqus username.)
        """
        super(CheckUsernameInputSet, self)._set_input('Username', value)
