...
class LookupMajors(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(LookupMajors, self).__init__(temboo_session, '/Library/DeptOfEducation/CollegesAndUniversities/LookupMajors')
...
class LookupMajorsInputSet(InputSet):
    ...
    def set_Keyword(self, value):
        ...
        """
        super(LookupMajorsInputSet, self)._set_input('Keyword', value)
    def set_MajorID(self, value):
        ...
        """
        super(LookupMajorsInputSet, self)._set_input('MajorID', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: xml (the default) and json.)
        """
        super(LookupMajorsInputSet, self)._set_input('ResponseFormat', value)
