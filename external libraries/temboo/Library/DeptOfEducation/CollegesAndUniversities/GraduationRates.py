...
class GraduationRates(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GraduationRates, self).__init__(temboo_session, '/Library/DeptOfEducation/CollegesAndUniversities/GraduationRates')
...
class GraduationRatesInputSet(InputSet):
    ...
    def set_InstitutionID(self, value):
        ...
        """
        super(GraduationRatesInputSet, self)._set_input('InstitutionID', value)
    def set_MaxRows(self, value):
        ...
        """
        super(GraduationRatesInputSet, self)._set_input('MaxRows', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: xml (the default) and json.)
        """
        super(GraduationRatesInputSet, self)._set_input('ResponseFormat', value)
