...
class LookupSchool(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(LookupSchool, self).__init__(temboo_session, '/Library/DeptOfEducation/CollegesAndUniversities/LookupSchool')
...
class LookupSchoolInputSet(InputSet):
    ...
    def set_Keyword(self, value):
        ...
        """
        super(LookupSchoolInputSet, self)._set_input('Keyword', value)
    def set_MaxRows(self, value):
        ...
        """
        super(LookupSchoolInputSet, self)._set_input('MaxRows', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: xml (the default) and json.)
        """
        super(LookupSchoolInputSet, self)._set_input('ResponseFormat', value)
