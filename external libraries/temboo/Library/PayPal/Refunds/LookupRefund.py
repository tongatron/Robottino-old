...
class LookupRefund(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(LookupRefund, self).__init__(temboo_session, '/Library/PayPal/Refunds/LookupRefund')
...
class LookupRefundInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(LookupRefundInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(LookupRefundInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(LookupRefundInputSet, self)._set_input('ClientSecret', value)
    def set_RefundID(self, value):
        ...
        """
        super(LookupRefundInputSet, self)._set_input('RefundID', value)
    def set_Scope(self, value):
        ...
        """
        super(LookupRefundInputSet, self)._set_input('Scope', value)
    def set_UseSandbox(self, value):
        ...
        """
        super(LookupRefundInputSet, self)._set_input('UseSandbox', value)
