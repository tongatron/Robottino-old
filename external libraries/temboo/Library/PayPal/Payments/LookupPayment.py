...
class LookupPayment(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(LookupPayment, self).__init__(temboo_session, '/Library/PayPal/Payments/LookupPayment')
...
class LookupPaymentInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(LookupPaymentInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(LookupPaymentInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(LookupPaymentInputSet, self)._set_input('ClientSecret', value)
    def set_PaymentID(self, value):
        ...
        """
        super(LookupPaymentInputSet, self)._set_input('PaymentID', value)
    def set_Scope(self, value):
        ...
        """
        super(LookupPaymentInputSet, self)._set_input('Scope', value)
    def set_UseSandbox(self, value):
        ...
        """
        super(LookupPaymentInputSet, self)._set_input('UseSandbox', value)
