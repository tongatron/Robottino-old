...
class GetTransactionDetails(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetTransactionDetails, self).__init__(temboo_session, '/Library/PayPal/Merchant/GetTransactionDetails')
...
class GetTransactionDetailsInputSet(InputSet):
    ...
    def set_Password(self, value):
        ...
        """
        super(GetTransactionDetailsInputSet, self)._set_input('Password', value)
    def set_Signature(self, value):
        ...
        """
        super(GetTransactionDetailsInputSet, self)._set_input('Signature', value)
    def set_TransactionID(self, value):
        ...
        """
        super(GetTransactionDetailsInputSet, self)._set_input('TransactionID', value)
    def set_UseSandbox(self, value):
        ...
        """
        super(GetTransactionDetailsInputSet, self)._set_input('UseSandbox', value)
    def set_Username(self, value):
        """
        Set the value of the Username input for this Choreo. ((required, string) The API Username provided by PayPal.)
        """
        super(GetTransactionDetailsInputSet, self)._set_input('Username', value)
