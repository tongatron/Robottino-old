...
class ShowActivity(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ShowActivity, self).__init__(temboo_session, '/Library/Zendesk/ActivityStream/ShowActivity')
...
class ShowActivityInputSet(InputSet):
    ...
    def set_Email(self, value):
        ...
        """
        super(ShowActivityInputSet, self)._set_input('Email', value)
    def set_ID(self, value):
        """
        Set the value of the ID input for this Choreo. ((required, string) The ID of the activity to retrieve.)
        """
        super(ShowActivityInputSet, self)._set_input('ID', value)
    def set_Password(self, value):
        """
        Set the value of the Password input for this Choreo. ((required, password) Your Zendesk password.)
        """
        super(ShowActivityInputSet, self)._set_input('Password', value)
    def set_Server(self, value):
        """
        Set the value of the Server input for this Choreo. ((required, string) Your Zendesk domain and subdomain (e.g., temboocare.zendesk.com).)
        """
        super(ShowActivityInputSet, self)._set_input('Server', value)
