...
class ShowUserIdentity(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ShowUserIdentity, self).__init__(temboo_session, '/Library/Zendesk/UserIdentities/ShowUserIdentity')
...
class ShowUserIdentityInputSet(InputSet):
    ...
    def set_Email(self, value):
        ...
        """
        super(ShowUserIdentityInputSet, self)._set_input('Email', value)
    def set_IdentityID(self, value):
        ...
        """
        super(ShowUserIdentityInputSet, self)._set_input('IdentityID', value)
    def set_Password(self, value):
        """
        Set the value of the Password input for this Choreo. ((required, password) Your Zendesk password.)
        """
        super(ShowUserIdentityInputSet, self)._set_input('Password', value)
    def set_Server(self, value):
        """
        Set the value of the Server input for this Choreo. ((required, string) Your Zendesk domain and subdomain (e.g., temboocare.zendesk.com).)
        """
        super(ShowUserIdentityInputSet, self)._set_input('Server', value)
    def set_UserID(self, value):
        """
        Set the value of the UserID input for this Choreo. ((conditional, string) The ID of the user.)
        """
        super(ShowUserIdentityInputSet, self)._set_input('UserID', value)
