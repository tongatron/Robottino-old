...
class ListTags(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListTags, self).__init__(temboo_session, '/Library/Zendesk/Tags/ListTags')
...
class ListTagsInputSet(InputSet):
    ...
    def set_Email(self, value):
        ...
        """
        super(ListTagsInputSet, self)._set_input('Email', value)
    ...
    def set_Password(self, value):
        ...
        """
        super(ListTagsInputSet, self)._set_input('Password', value)
    ...
    def set_Server(self, value):
        ...
        """
        super(ListTagsInputSet, self)._set_input('Server', value)
