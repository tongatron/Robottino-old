...
class SearchUsers(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(SearchUsers, self).__init__(temboo_session, '/Library/Zendesk/Users/SearchUsers')
...
class SearchUsersInputSet(InputSet):
    ...
    def set_Email(self, value):
        ...
        """
        super(SearchUsersInputSet, self)._set_input('Email', value)
    def set_Page(self, value):
        ...
        """
        super(SearchUsersInputSet, self)._set_input('Page', value)
    def set_Password(self, value):
        """
        Set the value of the Password input for this Choreo. ((required, password) Your Zendesk password.)
        """
        super(SearchUsersInputSet, self)._set_input('Password', value)
    def set_PerPage(self, value):
        ...
        """
        super(SearchUsersInputSet, self)._set_input('PerPage', value)
    ...
    def set_Server(self, value):
        ...
        """
        super(SearchUsersInputSet, self)._set_input('Server', value)
