...
class ListUsersByGroup(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListUsersByGroup, self).__init__(temboo_session, '/Library/Zendesk/Users/ListUsersByGroup')
...
class ListUsersByGroupInputSet(InputSet):
    ...
    def set_Page(self, value):
        ...
        """
        super(ListUsersByGroupInputSet, self)._set_input('Page', value)
    def set_Password(self, value):
        """
        Set the value of the Password input for this Choreo. ((required, password) Your Zendesk password.)
        """
        super(ListUsersByGroupInputSet, self)._set_input('Password', value)
    def set_PerPage(self, value):
        ...
        """
        super(ListUsersByGroupInputSet, self)._set_input('PerPage', value)
    def set_Server(self, value):
        """
        Set the value of the Server input for this Choreo. ((required, string) Your Zendesk domain and subdomain (e.g., temboocare.zendesk.com).)
        """
        super(ListUsersByGroupInputSet, self)._set_input('Server', value)
