...
class ListMonitoredTwitterHandles(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListMonitoredTwitterHandles, self).__init__(temboo_session, '/Library/Zendesk/MonitoredTwitterHandles/ListMonitoredTwitterHandles')
...
class ListMonitoredTwitterHandlesInputSet(InputSet):
    ...
    def set_Email(self, value):
        ...
        """
        super(ListMonitoredTwitterHandlesInputSet, self)._set_input('Email', value)
    def set_Page(self, value):
        ...
        """
        super(ListMonitoredTwitterHandlesInputSet, self)._set_input('Page', value)
    def set_Password(self, value):
        """
        Set the value of the Password input for this Choreo. ((required, password) Your Zendesk password.)
        """
        super(ListMonitoredTwitterHandlesInputSet, self)._set_input('Password', value)
    def set_PerPage(self, value):
        ...
        """
        super(ListMonitoredTwitterHandlesInputSet, self)._set_input('PerPage', value)
    def set_Server(self, value):
        """
        Set the value of the Server input for this Choreo. ((required, string) Your Zendesk domain and subdomain (e.g., temboocare.zendesk.com).)
        """
        super(ListMonitoredTwitterHandlesInputSet, self)._set_input('Server', value)
