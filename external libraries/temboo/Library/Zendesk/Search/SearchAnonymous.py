...
class SearchAnonymous(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(SearchAnonymous, self).__init__(temboo_session, '/Library/Zendesk/Search/SearchAnonymous')
...
class SearchAnonymousInputSet(InputSet):
    ...
    def set_Email(self, value):
        ...
        """
        super(SearchAnonymousInputSet, self)._set_input('Email', value)
    def set_Page(self, value):
        ...
        """
        super(SearchAnonymousInputSet, self)._set_input('Page', value)
    def set_Password(self, value):
        """
        Set the value of the Password input for this Choreo. ((required, password) Your Zendesk password.)
        """
        super(SearchAnonymousInputSet, self)._set_input('Password', value)
    def set_PerPage(self, value):
        ...
        """
        super(SearchAnonymousInputSet, self)._set_input('PerPage', value)
    def set_Query(self, value):
        """
        Set the value of the Query input for this Choreo. ((required, string) The search text to be matched.)
        """
        super(SearchAnonymousInputSet, self)._set_input('Query', value)
    def set_Server(self, value):
        """
        Set the value of the Server input for this Choreo. ((required, string) Your Zendesk domain and subdomain (e.g., temboocare.zendesk.com).)
        """
        super(SearchAnonymousInputSet, self)._set_input('Server', value)
    def set_SortBy(self, value):
        ...
        """
        super(SearchAnonymousInputSet, self)._set_input('SortBy', value)
    def set_SortOrder(self, value):
        ...
        """
        super(SearchAnonymousInputSet, self)._set_input('SortOrder', value)
