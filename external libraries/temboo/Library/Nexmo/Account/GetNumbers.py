...
class GetNumbers(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetNumbers, self).__init__(temboo_session, '/Library/Nexmo/Account/GetNumbers')
