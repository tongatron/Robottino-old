...
class GetBalance(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetBalance, self).__init__(temboo_session, '/Library/Nexmo/Account/GetBalance')
...
class GetBalanceInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(GetBalanceInputSet, self)._set_input('APIKey', value)
    def set_APISecret(self, value):
        """
        Set the value of the APISecret input for this Choreo. ((required, string) Your API Secret provided to you by Nexmo.)
        """
        super(GetBalanceInputSet, self)._set_input('APISecret', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are "json" (the default) and "xml".)
        """
        super(GetBalanceInputSet, self)._set_input('ResponseFormat', value)
