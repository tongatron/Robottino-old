...
class GetWeatherByAddress(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetWeatherByAddress, self).__init__(temboo_session, '/Library/Yahoo/Weather/GetWeatherByAddress')
...
class GetWeatherByAddressInputSet(InputSet):
    ...
    def set_Address(self, value):
        ...
        """
        super(GetWeatherByAddressInputSet, self)._set_input('Address', value)
    def set_AppID(self, value):
        """
        Set the value of the AppID input for this Choreo. ((optional, string) The App ID provided by Yahoo!)
        """
        super(GetWeatherByAddressInputSet, self)._set_input('AppID', value)
    def set_Units(self, value):
        ...
        """
        super(GetWeatherByAddressInputSet, self)._set_input('Units', value)
