...
class ShowPeople(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ShowPeople, self).__init__(temboo_session, '/Library/Highrise/ShowPeople')
...
class ShowPeopleInputSet(InputSet):
    ...
    def set_AccountName(self, value):
        ...
        """
        super(ShowPeopleInputSet, self)._set_input('AccountName', value)
    def set_ConactID(self, value):
        ...
        """
        super(ShowPeopleInputSet, self)._set_input('ConactID', value)
