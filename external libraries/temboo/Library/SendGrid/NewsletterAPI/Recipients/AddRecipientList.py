...
class AddRecipientList(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(AddRecipientList, self).__init__(temboo_session, '/Library/SendGrid/NewsletterAPI/Recipients/AddRecipientList')
...
class AddRecipientListInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(AddRecipientListInputSet, self)._set_input('APIKey', value)
    def set_APIUser(self, value):
        """
        Set the value of the APIUser input for this Choreo. ((required, string) The username registered with SendGrid.)
        """
        super(AddRecipientListInputSet, self)._set_input('APIUser', value)
    def set_List(self, value):
        ...
        """
        super(AddRecipientListInputSet, self)._set_input('List', value)
    def set_Name(self, value):
        ...
        """
        super(AddRecipientListInputSet, self)._set_input('Name', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format of the response from SendGrid, in either json, or xml.  Default is set to json.)
        """
        super(AddRecipientListInputSet, self)._set_input('ResponseFormat', value)
