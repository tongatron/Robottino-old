...
class ListAllIdentities(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListAllIdentities, self).__init__(temboo_session, '/Library/SendGrid/NewsletterAPI/Identity/ListAllIdentities')
...
class ListAllIdentitiesInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ListAllIdentitiesInputSet, self)._set_input('APIKey', value)
    def set_APIUser(self, value):
        """
        Set the value of the APIUser input for this Choreo. ((required, string) The username registered with SendGrid. )
        """
        super(ListAllIdentitiesInputSet, self)._set_input('APIUser', value)
    def set_Identity(self, value):
        ...
        """
        super(ListAllIdentitiesInputSet, self)._set_input('Identity', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(ListAllIdentitiesInputSet, self)._set_input('ResponseFormat', value)
