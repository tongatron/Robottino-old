...
class DeleteBlockedAddress(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteBlockedAddress, self).__init__(temboo_session, '/Library/SendGrid/WebAPI/Blocks/DeleteBlockedAddress')
...
class DeleteBlockedAddressInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(DeleteBlockedAddressInputSet, self)._set_input('APIKey', value)
    def set_APIUser(self, value):
        """
        Set the value of the APIUser input for this Choreo. ((required, string) The username registered with SendGrid.)
        """
        super(DeleteBlockedAddressInputSet, self)._set_input('APIUser', value)
    def set_EmailAddress(self, value):
        ...
        """
        super(DeleteBlockedAddressInputSet, self)._set_input('EmailAddress', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format of the response from SendGrid, in either json, or xml.  Default is set to json.)
        """
        super(DeleteBlockedAddressInputSet, self)._set_input('ResponseFormat', value)
