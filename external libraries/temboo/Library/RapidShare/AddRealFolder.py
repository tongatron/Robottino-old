...
class AddRealFolder(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(AddRealFolder, self).__init__(temboo_session, '/Library/RapidShare/AddRealFolder')
...
class AddRealFolderInputSet(InputSet):
    ...
    def set_Login(self, value):
        ...
        """
        super(AddRealFolderInputSet, self)._set_input('Login', value)
    def set_Name(self, value):
        ...
        """
        super(AddRealFolderInputSet, self)._set_input('Name', value)
    def set_Parent(self, value):
        ...
        """
        super(AddRealFolderInputSet, self)._set_input('Parent', value)
    def set_Password(self, value):
        """
        Set the value of the Password input for this Choreo. ((required, password) Your RapidShare password)
        """
        super(AddRealFolderInputSet, self)._set_input('Password', value)
