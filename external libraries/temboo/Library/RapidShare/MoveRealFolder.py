...
class MoveRealFolder(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(MoveRealFolder, self).__init__(temboo_session, '/Library/RapidShare/MoveRealFolder')
...
class MoveRealFolderInputSet(InputSet):
    ...
    def set_FolderId(self, value):
        ...
        """
        super(MoveRealFolderInputSet, self)._set_input('FolderId', value)
    def set_Login(self, value):
        """
        Set the value of the Login input for this Choreo. ((required, string) Your RapidShare username)
        """
        super(MoveRealFolderInputSet, self)._set_input('Login', value)
    def set_NewParent(self, value):
        ...
        """
        super(MoveRealFolderInputSet, self)._set_input('NewParent', value)
    def set_Password(self, value):
        """
        Set the value of the Password input for this Choreo. ((required, password) Your RapidShare password)
        """
        super(MoveRealFolderInputSet, self)._set_input('Password', value)
