...
class GetAccountDetails(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetAccountDetails, self).__init__(temboo_session, '/Library/RapidShare/GetAccountDetails')
...
class GetAccountDetailsInputSet(InputSet):
    ...
    def set_Login(self, value):
        ...
        """
        super(GetAccountDetailsInputSet, self)._set_input('Login', value)
    def set_Password(self, value):
        """
        Set the value of the Password input for this Choreo. ((required, password) Your RapidShare password)
        """
        super(GetAccountDetailsInputSet, self)._set_input('Password', value)
    def set_WithCookie(self, value):
        ...
        """
        super(GetAccountDetailsInputSet, self)._set_input('WithCookie', value)
    def set_WithPublicId(self, value):
        ...
        """
        super(GetAccountDetailsInputSet, self)._set_input('WithPublicId', value)
