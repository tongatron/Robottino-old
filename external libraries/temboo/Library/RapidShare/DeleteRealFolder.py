...
class DeleteRealFolder(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteRealFolder, self).__init__(temboo_session, '/Library/RapidShare/DeleteRealFolder')
...
class DeleteRealFolderInputSet(InputSet):
    ...
    def set_Login(self, value):
        ...
        """
        super(DeleteRealFolderInputSet, self)._set_input('Login', value)
    def set_Password(self, value):
        """
        Set the value of the Password input for this Choreo. ((required, password) Your RapidShare password)
        """
        super(DeleteRealFolderInputSet, self)._set_input('Password', value)
    def set_RealFolder(self, value):
        ...
        """
        super(DeleteRealFolderInputSet, self)._set_input('RealFolder', value)
