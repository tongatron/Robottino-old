...
class SearchByID(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(SearchByID, self).__init__(temboo_session, '/Library/NPR/StationFinder/SearchByID')
...
class SearchByIDInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(SearchByIDInputSet, self)._set_input('APIKey', value)
    def set_ID(self, value):
        ...
        """
        super(SearchByIDInputSet, self)._set_input('ID', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are xml (the default), and json.)
        """
        super(SearchByIDInputSet, self)._set_input('ResponseFormat', value)
