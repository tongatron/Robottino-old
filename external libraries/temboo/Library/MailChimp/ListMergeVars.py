...
class ListMergeVars(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListMergeVars, self).__init__(temboo_session, '/Library/MailChimp/ListMergeVars')
...
class ListMergeVarsInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ListMergeVarsInputSet, self)._set_input('APIKey', value)
    def set_ListId(self, value):
        ...
        """
        super(ListMergeVarsInputSet, self)._set_input('ListId', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(ListMergeVarsInputSet, self)._set_input('ResponseFormat', value)
