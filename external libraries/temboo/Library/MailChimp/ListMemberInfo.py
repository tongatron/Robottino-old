...
class ListMemberInfo(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListMemberInfo, self).__init__(temboo_session, '/Library/MailChimp/ListMemberInfo')
...
class ListMemberInfoInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ListMemberInfoInputSet, self)._set_input('APIKey', value)
    def set_EmailAddress(self, value):
        ...
        """
        super(ListMemberInfoInputSet, self)._set_input('EmailAddress', value)
    def set_ListId(self, value):
        ...
        """
        super(ListMemberInfoInputSet, self)._set_input('ListId', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(ListMemberInfoInputSet, self)._set_input('ResponseFormat', value)
