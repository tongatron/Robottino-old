...
class GetLenders(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetLenders, self).__init__(temboo_session, '/Library/Kiva/Loans/GetLenders')
...
class GetLendersInputSet(InputSet):
    ...
    def set_AppID(self, value):
        ...
        """
        super(GetLendersInputSet, self)._set_input('AppID', value)
    def set_LoanID(self, value):
        ...
        """
        super(GetLendersInputSet, self)._set_input('LoanID', value)
    def set_Page(self, value):
        ...
        """
        super(GetLendersInputSet, self)._set_input('Page', value)
    def set_ResponseType(self, value):
        ...
        """
        super(GetLendersInputSet, self)._set_input('ResponseType', value)
