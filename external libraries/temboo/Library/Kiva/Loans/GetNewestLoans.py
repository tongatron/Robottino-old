...
class GetNewestLoans(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetNewestLoans, self).__init__(temboo_session, '/Library/Kiva/Loans/GetNewestLoans')
...
class GetNewestLoansInputSet(InputSet):
    ...
    def set_AppID(self, value):
        ...
        """
        super(GetNewestLoansInputSet, self)._set_input('AppID', value)
    def set_Page(self, value):
        ...
        """
        super(GetNewestLoansInputSet, self)._set_input('Page', value)
    def set_ResponseType(self, value):
        ...
        """
        super(GetNewestLoansInputSet, self)._set_input('ResponseType', value)
