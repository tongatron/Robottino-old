...
class GetLenderTeams(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetLenderTeams, self).__init__(temboo_session, '/Library/Kiva/Lenders/GetLenderTeams')
...
class GetLenderTeamsInputSet(InputSet):
    ...
    def set_AppID(self, value):
        ...
        """
        super(GetLenderTeamsInputSet, self)._set_input('AppID', value)
    def set_LenderName(self, value):
        ...
        """
        super(GetLenderTeamsInputSet, self)._set_input('LenderName', value)
    def set_Page(self, value):
        ...
        """
        super(GetLenderTeamsInputSet, self)._set_input('Page', value)
    def set_ResponseType(self, value):
        ...
        """
        super(GetLenderTeamsInputSet, self)._set_input('ResponseType', value)
