...
class GetLenderDetails(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetLenderDetails, self).__init__(temboo_session, '/Library/Kiva/Lenders/GetLenderDetails')
...
class GetLenderDetailsInputSet(InputSet):
    ...
    def set_AppID(self, value):
        ...
        """
        super(GetLenderDetailsInputSet, self)._set_input('AppID', value)
    def set_LenderName(self, value):
        ...
        """
        super(GetLenderDetailsInputSet, self)._set_input('LenderName', value)
    def set_ResponseType(self, value):
        ...
        """
        super(GetLenderDetailsInputSet, self)._set_input('ResponseType', value)
