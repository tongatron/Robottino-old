...
class GetTeamLoans(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetTeamLoans, self).__init__(temboo_session, '/Library/Kiva/Teams/GetTeamLoans')
...
class GetTeamLoansInputSet(InputSet):
    ...
    def set_AppID(self, value):
        ...
        """
        super(GetTeamLoansInputSet, self)._set_input('AppID', value)
    def set_Page(self, value):
        ...
        """
        super(GetTeamLoansInputSet, self)._set_input('Page', value)
    def set_ResponseType(self, value):
        ...
        """
        super(GetTeamLoansInputSet, self)._set_input('ResponseType', value)
    def set_SortBy(self, value):
        ...
        """
        super(GetTeamLoansInputSet, self)._set_input('SortBy', value)
    def set_TeamID(self, value):
        ...
        """
        super(GetTeamLoansInputSet, self)._set_input('TeamID', value)
