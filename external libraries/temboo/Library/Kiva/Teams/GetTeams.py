...
class GetTeams(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetTeams, self).__init__(temboo_session, '/Library/Kiva/Teams/GetTeams')
...
class GetTeamsInputSet(InputSet):
    ...
    def set_AppID(self, value):
        ...
        """
        super(GetTeamsInputSet, self)._set_input('AppID', value)
    def set_ResponseType(self, value):
        ...
        """
        super(GetTeamsInputSet, self)._set_input('ResponseType', value)
    def set_TeamID(self, value):
        ...
        """
        super(GetTeamsInputSet, self)._set_input('TeamID', value)
