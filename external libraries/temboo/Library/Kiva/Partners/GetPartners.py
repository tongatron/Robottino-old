...
class GetPartners(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetPartners, self).__init__(temboo_session, '/Library/Kiva/Partners/GetPartners')
...
class GetPartnersInputSet(InputSet):
    ...
    def set_AppID(self, value):
        ...
        """
        super(GetPartnersInputSet, self)._set_input('AppID', value)
    def set_Page(self, value):
        ...
        """
        super(GetPartnersInputSet, self)._set_input('Page', value)
    def set_ResponseType(self, value):
        ...
        """
        super(GetPartnersInputSet, self)._set_input('ResponseType', value)
