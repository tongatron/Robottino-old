...
class AddressValidationRequest(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(AddressValidationRequest, self).__init__(temboo_session, '/Library/FedEx/AddressValidationRequest')
...
class AddressValidationRequestInputSet(InputSet):
    ...
    def set_AccountNumber(self, value):
        ...
        """
        super(AddressValidationRequestInputSet, self)._set_input('AccountNumber', value)
    def set_AuthenticationKey(self, value):
        ...
        """
        super(AddressValidationRequestInputSet, self)._set_input('AuthenticationKey', value)
    def set_City(self, value):
        """
        Set the value of the City input for this Choreo. ((required, string) The city to use in the address validation request)
        """
        super(AddressValidationRequestInputSet, self)._set_input('City', value)
    def set_CountryCode(self, value):
        ...
        """
        super(AddressValidationRequestInputSet, self)._set_input('CountryCode', value)
    def set_MeterNumber(self, value):
        ...
        """
        super(AddressValidationRequestInputSet, self)._set_input('MeterNumber', value)
    def set_Password(self, value):
        ...
        """
        super(AddressValidationRequestInputSet, self)._set_input('Password', value)
    def set_PostalCode(self, value):
        ...
        """
        super(AddressValidationRequestInputSet, self)._set_input('PostalCode', value)
    def set_State(self, value):
        """
        Set the value of the State input for this Choreo. ((required, string) The state to use in the address validation request)
        """
        super(AddressValidationRequestInputSet, self)._set_input('State', value)
    def set_Street(self, value):
        ...
        """
        super(AddressValidationRequestInputSet, self)._set_input('Street', value)
