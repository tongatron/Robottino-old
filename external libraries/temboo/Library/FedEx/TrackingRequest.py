...
class TrackingRequest(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(TrackingRequest, self).__init__(temboo_session, '/Library/FedEx/TrackingRequest')
...
class TrackingRequestInputSet(InputSet):
    ...
    def set_AccountNumber(self, value):
        ...
        """
        super(TrackingRequestInputSet, self)._set_input('AccountNumber', value)
    def set_AuthenticationKey(self, value):
        ...
        """
        super(TrackingRequestInputSet, self)._set_input('AuthenticationKey', value)
    def set_MeterNumber(self, value):
        ...
        """
        super(TrackingRequestInputSet, self)._set_input('MeterNumber', value)
    def set_Password(self, value):
        ...
        """
        super(TrackingRequestInputSet, self)._set_input('Password', value)
    def set_TrackingNumber(self, value):
        ...
        """
        super(TrackingRequestInputSet, self)._set_input('TrackingNumber', value)
