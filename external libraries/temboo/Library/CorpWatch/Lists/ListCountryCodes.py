...
class ListCountryCodes(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListCountryCodes, self).__init__(temboo_session, '/Library/CorpWatch/Lists/ListCountryCodes')
...
class ListCountryCodesInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ListCountryCodesInputSet, self)._set_input('APIKey', value)
    def set_Index(self, value):
        ...
        """
        super(ListCountryCodesInputSet, self)._set_input('Index', value)
    def set_Limit(self, value):
        ...
        """
        super(ListCountryCodesInputSet, self)._set_input('Limit', value)
    def set_ResponseType(self, value):
        ...
        """
        super(ListCountryCodesInputSet, self)._set_input('ResponseType', value)
