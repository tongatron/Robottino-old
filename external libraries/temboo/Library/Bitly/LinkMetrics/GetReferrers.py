...
class GetReferrers(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetReferrers, self).__init__(temboo_session, '/Library/Bitly/LinkMetrics/GetReferrers')
...
class GetReferrersInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetReferrersInputSet, self)._set_input('AccessToken', value)
    def set_Limit(self, value):
        ...
        """
        super(GetReferrersInputSet, self)._set_input('Limit', value)
    def set_Link(self, value):
        """
        Set the value of the Link input for this Choreo. ((required, string) A bitly link.)
        """
        super(GetReferrersInputSet, self)._set_input('Link', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(GetReferrersInputSet, self)._set_input('ResponseFormat', value)
    def set_Rollup(self, value):
        ...
        """
        super(GetReferrersInputSet, self)._set_input('Rollup', value)
    def set_Timestamp(self, value):
        ...
        """
        super(GetReferrersInputSet, self)._set_input('Timestamp', value)
    def set_Timezone(self, value):
        ...
        """
        super(GetReferrersInputSet, self)._set_input('Timezone', value)
    def set_UnitName(self, value):
        ...
        """
        super(GetReferrersInputSet, self)._set_input('UnitName', value)
    def set_UnitValue(self, value):
        ...
        """
        super(GetReferrersInputSet, self)._set_input('UnitValue', value)
