...
class DeleteDBInstance(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteDBInstance, self).__init__(temboo_session, '/Library/Amazon/RDS/DeleteDBInstance')
...
class DeleteDBInstanceInputSet(InputSet):
    ...
    def set_AWSAccessKeyId(self, value):
        ...
        """
        super(DeleteDBInstanceInputSet, self)._set_input('AWSAccessKeyId', value)
    def set_AWSSecretKeyId(self, value):
        """
        Set the value of the AWSSecretKeyId input for this Choreo. ((required, string) The Secret Key ID provided by Amazon Web Services.)
        """
        super(DeleteDBInstanceInputSet, self)._set_input('AWSSecretKeyId', value)
    def set_DBInstanceIdentifier(self, value):
        ...
        """
        super(DeleteDBInstanceInputSet, self)._set_input('DBInstanceIdentifier', value)
    def set_UserRegion(self, value):
        ...
        """
        super(DeleteDBInstanceInputSet, self)._set_input('UserRegion', value)
