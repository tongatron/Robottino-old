...
class DeleteDBSnapshot(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteDBSnapshot, self).__init__(temboo_session, '/Library/Amazon/RDS/DeleteDBSnapshot')
...
class DeleteDBSnapshotInputSet(InputSet):
    ...
    def set_AWSAccessKeyId(self, value):
        ...
        """
        super(DeleteDBSnapshotInputSet, self)._set_input('AWSAccessKeyId', value)
    def set_AWSSecretKeyId(self, value):
        """
        Set the value of the AWSSecretKeyId input for this Choreo. ((required, string) The Secret Key ID provided by Amazon Web Services.)
        """
        super(DeleteDBSnapshotInputSet, self)._set_input('AWSSecretKeyId', value)
    def set_DBSnapshotIdentifier(self, value):
        ...
        """
        super(DeleteDBSnapshotInputSet, self)._set_input('DBSnapshotIdentifier', value)
    def set_UserRegion(self, value):
        ...
        """
        super(DeleteDBSnapshotInputSet, self)._set_input('UserRegion', value)
