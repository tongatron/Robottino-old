...
class PutBucketVersioning(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(PutBucketVersioning, self).__init__(temboo_session, '/Library/Amazon/S3/PutBucketVersioning')
...
class PutBucketVersioningInputSet(InputSet):
    ...
    def set_AWSAccessKeyId(self, value):
        ...
        """
        super(PutBucketVersioningInputSet, self)._set_input('AWSAccessKeyId', value)
    def set_AWSSecretKeyId(self, value):
        """
        Set the value of the AWSSecretKeyId input for this Choreo. ((required, string) The Secret Key ID provided by Amazon Web Services.)
        """
        super(PutBucketVersioningInputSet, self)._set_input('AWSSecretKeyId', value)
    def set_BucketName(self, value):
        ...
        """
        super(PutBucketVersioningInputSet, self)._set_input('BucketName', value)
    def set_Status(self, value):
        ...
        """
        super(PutBucketVersioningInputSet, self)._set_input('Status', value)
