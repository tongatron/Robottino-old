...
class DeleteBucketTagging(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteBucketTagging, self).__init__(temboo_session, '/Library/Amazon/S3/DeleteBucketTagging')
...
class DeleteBucketTaggingInputSet(InputSet):
    ...
    def set_AWSAccessKeyId(self, value):
        ...
        """
        super(DeleteBucketTaggingInputSet, self)._set_input('AWSAccessKeyId', value)
    def set_AWSSecretKeyId(self, value):
        """
        Set the value of the AWSSecretKeyId input for this Choreo. ((required, string) The Secret Key ID provided by Amazon Web Services.)
        """
        super(DeleteBucketTaggingInputSet, self)._set_input('AWSSecretKeyId', value)
    def set_BucketName(self, value):
        """
        Set the value of the BucketName input for this Choreo. ((required, string) The name of the bucket to remove tags from.)
        """
        super(DeleteBucketTaggingInputSet, self)._set_input('BucketName', value)
