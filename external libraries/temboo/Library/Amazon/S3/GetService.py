...
class GetService(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetService, self).__init__(temboo_session, '/Library/Amazon/S3/GetService')
...
class GetServiceInputSet(InputSet):
    ...
    def set_AWSAccessKeyId(self, value):
        ...
        """
        super(GetServiceInputSet, self)._set_input('AWSAccessKeyId', value)
    def set_AWSSecretKeyId(self, value):
        """
        Set the value of the AWSSecretKeyId input for this Choreo. ((required, string) The Secret Key ID provided by Amazon Web Services.)
        """
        super(GetServiceInputSet, self)._set_input('AWSSecretKeyId', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are "xml" (the default) and "json".)
        """
        super(GetServiceInputSet, self)._set_input('ResponseFormat', value)
