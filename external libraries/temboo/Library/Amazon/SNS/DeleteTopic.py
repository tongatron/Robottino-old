...
class DeleteTopic(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteTopic, self).__init__(temboo_session, '/Library/Amazon/SNS/DeleteTopic')
...
class DeleteTopicInputSet(InputSet):
    ...
    def set_AWSAccessKeyId(self, value):
        ...
        """
        super(DeleteTopicInputSet, self)._set_input('AWSAccessKeyId', value)
    def set_AWSSecretKeyId(self, value):
        """
        Set the value of the AWSSecretKeyId input for this Choreo. ((required, string) The Secret Key ID provided by Amazon Web Services.)
        """
        super(DeleteTopicInputSet, self)._set_input('AWSSecretKeyId', value)
    def set_TopicArn(self, value):
        ...
        """
        super(DeleteTopicInputSet, self)._set_input('TopicArn', value)
    def set_UserRegion(self, value):
        ...
        """
        super(DeleteTopicInputSet, self)._set_input('UserRegion', value)
