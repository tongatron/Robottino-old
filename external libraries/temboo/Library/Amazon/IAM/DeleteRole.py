...
class DeleteRole(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteRole, self).__init__(temboo_session, '/Library/Amazon/IAM/DeleteRole')
...
class DeleteRoleInputSet(InputSet):
    ...
    def set_AWSAccessKeyId(self, value):
        ...
        """
        super(DeleteRoleInputSet, self)._set_input('AWSAccessKeyId', value)
    def set_AWSSecretKeyId(self, value):
        """
        Set the value of the AWSSecretKeyId input for this Choreo. ((required, string) The Secret Key ID provided by Amazon Web Services.)
        """
        super(DeleteRoleInputSet, self)._set_input('AWSSecretKeyId', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are "xml" (the default) and "json".)
        """
        super(DeleteRoleInputSet, self)._set_input('ResponseFormat', value)
    def set_RoleName(self, value):
        ...
        """
        super(DeleteRoleInputSet, self)._set_input('RoleName', value)
