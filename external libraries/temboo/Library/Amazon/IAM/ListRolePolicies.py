...
class ListRolePolicies(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListRolePolicies, self).__init__(temboo_session, '/Library/Amazon/IAM/ListRolePolicies')
...
class ListRolePoliciesInputSet(InputSet):
    ...
    def set_AWSAccessKeyId(self, value):
        ...
        """
        super(ListRolePoliciesInputSet, self)._set_input('AWSAccessKeyId', value)
    def set_AWSSecretKeyId(self, value):
        """
        Set the value of the AWSSecretKeyId input for this Choreo. ((required, string) The Secret Key ID provided by Amazon Web Services.)
        """
        super(ListRolePoliciesInputSet, self)._set_input('AWSSecretKeyId', value)
    def set_Marker(self, value):
        ...
        """
        super(ListRolePoliciesInputSet, self)._set_input('Marker', value)
    def set_MaxItems(self, value):
        ...
        """
        super(ListRolePoliciesInputSet, self)._set_input('MaxItems', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are "xml" (the default) and "json".)
        """
        super(ListRolePoliciesInputSet, self)._set_input('ResponseFormat', value)
    def set_RoleName(self, value):
        ...
        """
        super(ListRolePoliciesInputSet, self)._set_input('RoleName', value)
