...
class GetUser(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetUser, self).__init__(temboo_session, '/Library/Amazon/IAM/GetUser')
...
class GetUserInputSet(InputSet):
    ...
    def set_AWSAccessKeyId(self, value):
        ...
        """
        super(GetUserInputSet, self)._set_input('AWSAccessKeyId', value)
    def set_AWSSecretKeyId(self, value):
        """
        Set the value of the AWSSecretKeyId input for this Choreo. ((required, string) The Secret Key ID provided by Amazon Web Services.)
        """
        super(GetUserInputSet, self)._set_input('AWSSecretKeyId', value)
