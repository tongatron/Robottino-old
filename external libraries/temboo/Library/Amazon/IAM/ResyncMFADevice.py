...
class ResyncMFADevice(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ResyncMFADevice, self).__init__(temboo_session, '/Library/Amazon/IAM/ResyncMFADevice')
...
class ResyncMFADeviceInputSet(InputSet):
    ...
    def set_AWSAccessKeyId(self, value):
        ...
        """
        super(ResyncMFADeviceInputSet, self)._set_input('AWSAccessKeyId', value)
    def set_AWSSecretKeyId(self, value):
        """
        Set the value of the AWSSecretKeyId input for this Choreo. ((required, string) The Secret Key ID provided by Amazon Web Services.)
        """
        super(ResyncMFADeviceInputSet, self)._set_input('AWSSecretKeyId', value)
    def set_AuthenticationCode1(self, value):
        ...
        """
        super(ResyncMFADeviceInputSet, self)._set_input('AuthenticationCode1', value)
    def set_AuthenticationCode2(self, value):
        ...
        """
        super(ResyncMFADeviceInputSet, self)._set_input('AuthenticationCode2', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are "xml" (the default) and "json".)
        """
        super(ResyncMFADeviceInputSet, self)._set_input('ResponseFormat', value)
    def set_SerialNumber(self, value):
        ...
        """
        super(ResyncMFADeviceInputSet, self)._set_input('SerialNumber', value)
    def set_UserName(self, value):
        ...
        """
        super(ResyncMFADeviceInputSet, self)._set_input('UserName', value)
