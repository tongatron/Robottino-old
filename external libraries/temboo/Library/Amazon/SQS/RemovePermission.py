...
class RemovePermission(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(RemovePermission, self).__init__(temboo_session, '/Library/Amazon/SQS/RemovePermission')
...
class RemovePermissionInputSet(InputSet):
    ...
    def set_AWSAccountId(self, value):
        ...
        """
        super(RemovePermissionInputSet, self)._set_input('AWSAccountId', value)
    ...
    def set_QueueName(self, value):
        ...
        """
        super(RemovePermissionInputSet, self)._set_input('QueueName', value)
