...
class AddPermission(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(AddPermission, self).__init__(temboo_session, '/Library/Amazon/SQS/AddPermission')
...
class AddPermissionInputSet(InputSet):
    ...
    def set_AWSAccountId1(self, value):
        ...
        """
        super(AddPermissionInputSet, self)._set_input('AWSAccountId1', value)
    ...
    def set_QueueName(self, value):
        ...
        """
        super(AddPermissionInputSet, self)._set_input('QueueName', value)
