...
class DescribeAvailabilityZones(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DescribeAvailabilityZones, self).__init__(temboo_session, '/Library/Amazon/EC2/DescribeAvailabilityZones')
...
class DescribeAvailabilityZonesInputSet(InputSet):
    ...
    def set_AWSAccessKeyId(self, value):
        ...
        """
        super(DescribeAvailabilityZonesInputSet, self)._set_input('AWSAccessKeyId', value)
    def set_AWSSecretKeyId(self, value):
        """
        Set the value of the AWSSecretKeyId input for this Choreo. ((required, string) The Secret Key ID provided by Amazon Web Services.)
        """
        super(DescribeAvailabilityZonesInputSet, self)._set_input('AWSSecretKeyId', value)
    def set_FilterName(self, value):
        ...
        """
        super(DescribeAvailabilityZonesInputSet, self)._set_input('FilterName', value)
    def set_FilterValue(self, value):
        ...
        """
        super(DescribeAvailabilityZonesInputSet, self)._set_input('FilterValue', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are "xml" (the default) and "json".)
        """
        super(DescribeAvailabilityZonesInputSet, self)._set_input('ResponseFormat', value)
    def set_UserRegion(self, value):
        ...
        """
        super(DescribeAvailabilityZonesInputSet, self)._set_input('UserRegion', value)
    def set_ZoneName(self, value):
        ...
        """
        super(DescribeAvailabilityZonesInputSet, self)._set_input('ZoneName', value)
