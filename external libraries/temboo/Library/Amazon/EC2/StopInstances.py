...
class StopInstances(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(StopInstances, self).__init__(temboo_session, '/Library/Amazon/EC2/StopInstances')
...
class StopInstancesInputSet(InputSet):
    ...
    def set_AWSAccessKeyId(self, value):
        ...
        """
        super(StopInstancesInputSet, self)._set_input('AWSAccessKeyId', value)
    def set_AWSSecretKeyId(self, value):
        """
        Set the value of the AWSSecretKeyId input for this Choreo. ((required, string) The Secret Key ID provided by Amazon Web Services.)
        """
        super(StopInstancesInputSet, self)._set_input('AWSSecretKeyId', value)
    def set_InstanceId(self, value):
        ...
        """
        super(StopInstancesInputSet, self)._set_input('InstanceId', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are "xml" (the default) and "json".)
        """
        super(StopInstancesInputSet, self)._set_input('ResponseFormat', value)
    def set_UserRegion(self, value):
        ...
        """
        super(StopInstancesInputSet, self)._set_input('UserRegion', value)
