...
class GetKeyStatus(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetKeyStatus, self).__init__(temboo_session, '/Library/Wordnik/Account/GetKeyStatus')
...
class GetKeyStatusInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(GetKeyStatusInputSet, self)._set_input('APIKey', value)
    def set_ResponseType(self, value):
        ...
        """
        super(GetKeyStatusInputSet, self)._set_input('ResponseType', value)
