...
class GetAuthToken(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetAuthToken, self).__init__(temboo_session, '/Library/Wordnik/Account/GetAuthToken')
