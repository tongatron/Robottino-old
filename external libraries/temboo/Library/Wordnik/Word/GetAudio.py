...
class GetAudio(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetAudio, self).__init__(temboo_session, '/Library/Wordnik/Word/GetAudio')
...
class GetAudioInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(GetAudioInputSet, self)._set_input('APIKey', value)
    ...
    def set_ResponseType(self, value):
        ...
        """
        super(GetAudioInputSet, self)._set_input('ResponseType', value)
    def set_UseCanonical(self, value):
        ...
        """
        super(GetAudioInputSet, self)._set_input('UseCanonical', value)
    def set_Word(self, value):
        ...
        """
        super(GetAudioInputSet, self)._set_input('Word', value)
