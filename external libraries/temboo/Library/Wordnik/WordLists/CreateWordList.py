...
class CreateWordList(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CreateWordList, self).__init__(temboo_session, '/Library/Wordnik/WordLists/CreateWordList')
...
class CreateWordListInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(CreateWordListInputSet, self)._set_input('APIKey', value)
    def set_ListDescription(self, value):
        ...
        """
        super(CreateWordListInputSet, self)._set_input('ListDescription', value)
    def set_ListName(self, value):
        """
        Set the value of the ListName input for this Choreo. ((required, string) Name of list to create.)
        """
        super(CreateWordListInputSet, self)._set_input('ListName', value)
