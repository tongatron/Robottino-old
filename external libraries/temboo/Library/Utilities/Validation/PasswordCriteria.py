...
class PasswordCriteria(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(PasswordCriteria, self).__init__(temboo_session, '/Library/Utilities/Validation/PasswordCriteria')
...
class PasswordCriteriaInputSet(InputSet):
    ...
    def set_MaxLength(self, value):
        ...
        """
        super(PasswordCriteriaInputSet, self)._set_input('MaxLength', value)
    def set_MinLength(self, value):
        ...
        """
        super(PasswordCriteriaInputSet, self)._set_input('MinLength', value)
    def set_Password(self, value):
        """
        Set the value of the Password input for this Choreo. ((required, string) The password to validate.)
        """
        super(PasswordCriteriaInputSet, self)._set_input('Password', value)
