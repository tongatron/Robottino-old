...
class RussianPostalCodes(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(RussianPostalCodes, self).__init__(temboo_session, '/Library/Utilities/Validation/RussianPostalCodes')
...
class RussianPostalCodesInputSet(InputSet):
    ...
    def set_ZipCode(self, value):
        ...
        """
        super(RussianPostalCodesInputSet, self)._set_input('ZipCode', value)
