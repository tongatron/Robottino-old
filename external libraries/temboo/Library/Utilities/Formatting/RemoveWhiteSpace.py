...
class RemoveWhiteSpace(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(RemoveWhiteSpace, self).__init__(temboo_session, '/Library/Utilities/Formatting/RemoveWhiteSpace')
...
class RemoveWhiteSpaceInputSet(InputSet):
    ...
    def set_FormattedText(self, value):
        ...
        """
        super(RemoveWhiteSpaceInputSet, self)._set_input('FormattedText', value)
