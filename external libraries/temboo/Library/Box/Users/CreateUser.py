...
class CreateUser(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CreateUser, self).__init__(temboo_session, '/Library/Box/Users/CreateUser')
...
class CreateUserInputSet(InputSet):
    ...
    def set_UserObject(self, value):
        ...
        """
        super(CreateUserInputSet, self)._set_input('UserObject', value)
    def set_AccessToken(self, value):
        """
        Set the value of the AccessToken input for this Choreo. ((required, string) The access token retrieved during the OAuth2 process.)
        """
        super(CreateUserInputSet, self)._set_input('AccessToken', value)
    def set_AsUser(self, value):
        ...
        """
        super(CreateUserInputSet, self)._set_input('AsUser', value)
    def set_Fields(self, value):
        """
        Set the value of the Fields input for this Choreo. ((optional, string) A comma-separated list of fields to include in the response.)
        """
        super(CreateUserInputSet, self)._set_input('Fields', value)
