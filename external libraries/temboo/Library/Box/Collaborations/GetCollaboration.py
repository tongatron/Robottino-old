...
class GetCollaboration(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetCollaboration, self).__init__(temboo_session, '/Library/Box/Collaborations/GetCollaboration')
...
class GetCollaborationInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetCollaborationInputSet, self)._set_input('AccessToken', value)
    def set_AsUser(self, value):
        ...
        """
        super(GetCollaborationInputSet, self)._set_input('AsUser', value)
    def set_CollaborationID(self, value):
        ...
        """
        super(GetCollaborationInputSet, self)._set_input('CollaborationID', value)
    def set_Fields(self, value):
        """
        Set the value of the Fields input for this Choreo. ((optional, string) A comma-separated list of fields to include in the response.)
        """
        super(GetCollaborationInputSet, self)._set_input('Fields', value)
