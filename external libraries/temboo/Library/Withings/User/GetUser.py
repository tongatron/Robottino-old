...
class GetUser(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetUser, self).__init__(temboo_session, '/Library/Withings/User/GetUser')
