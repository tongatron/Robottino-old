...
class CompleteEntry(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CompleteEntry, self).__init__(temboo_session, '/Library/Basecamp/CompleteEntry')
...
class CompleteEntryInputSet(InputSet):
    ...
    def set_AccountName(self, value):
        ...
        """
        super(CompleteEntryInputSet, self)._set_input('AccountName', value)
    def set_EntryID(self, value):
        ...
        """
        super(CompleteEntryInputSet, self)._set_input('EntryID', value)
    def set_Password(self, value):
        ...
        """
        super(CompleteEntryInputSet, self)._set_input('Password', value)
    def set_ProjectID(self, value):
        ...
        """
        super(CompleteEntryInputSet, self)._set_input('ProjectID', value)
    def set_Username(self, value):
        """
        Set the value of the Username input for this Choreo. ((required, string) A Basecamp account username or API Key.)
        """
        super(CompleteEntryInputSet, self)._set_input('Username', value)
