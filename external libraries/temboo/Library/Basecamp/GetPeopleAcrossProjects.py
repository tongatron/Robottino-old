...
class GetPeopleAcrossProjects(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetPeopleAcrossProjects, self).__init__(temboo_session, '/Library/Basecamp/GetPeopleAcrossProjects')
...
class GetPeopleAcrossProjectsInputSet(InputSet):
    ...
    def set_AccountName(self, value):
        ...
        """
        super(GetPeopleAcrossProjectsInputSet, self)._set_input('AccountName', value)
    def set_Password(self, value):
        ...
        """
        super(GetPeopleAcrossProjectsInputSet, self)._set_input('Password', value)
    def set_Username(self, value):
        """
        Set the value of the Username input for this Choreo. ((required, string) Your Basecamp username or API Key.)
        """
        super(GetPeopleAcrossProjectsInputSet, self)._set_input('Username', value)
