...
class DeleteList(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteList, self).__init__(temboo_session, '/Library/Basecamp/DeleteList')
...
class DeleteListInputSet(InputSet):
    ...
    def set_AccountName(self, value):
        ...
        """
        super(DeleteListInputSet, self)._set_input('AccountName', value)
    def set_ListID(self, value):
        """
        Set the value of the ListID input for this Choreo. ((required, integer) The ID for the To-Do list to delete.)
        """
        super(DeleteListInputSet, self)._set_input('ListID', value)
