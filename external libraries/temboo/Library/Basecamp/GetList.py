...
class GetList(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetList, self).__init__(temboo_session, '/Library/Basecamp/GetList')
...
class GetListInputSet(InputSet):
    ...
    def set_AccountName(self, value):
        ...
        """
        super(GetListInputSet, self)._set_input('AccountName', value)
