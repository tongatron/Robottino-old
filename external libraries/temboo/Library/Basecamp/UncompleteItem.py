...
class UncompleteItem(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(UncompleteItem, self).__init__(temboo_session, '/Library/Basecamp/UncompleteItem')
...
class UncompleteItemInputSet(InputSet):
    ...
    def set_AccountName(self, value):
        ...
        """
        super(UncompleteItemInputSet, self)._set_input('AccountName', value)
    def set_ItemID(self, value):
        """
        Set the value of the ItemID input for this Choreo. ((required, integer) The ID of the item to mark as complete.)
        """
        super(UncompleteItemInputSet, self)._set_input('ItemID', value)
    def set_Password(self, value):
        ...
        """
        super(UncompleteItemInputSet, self)._set_input('Password', value)
    def set_Username(self, value):
        """
        Set the value of the Username input for this Choreo. ((required, string) A Basecamp account username or API Key.)
        """
        super(UncompleteItemInputSet, self)._set_input('Username', value)
