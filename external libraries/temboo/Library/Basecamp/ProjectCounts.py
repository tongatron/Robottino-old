...
class ProjectCounts(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ProjectCounts, self).__init__(temboo_session, '/Library/Basecamp/ProjectCounts')
...
class ProjectCountsInputSet(InputSet):
    ...
    def set_AccountName(self, value):
        ...
        """
        super(ProjectCountsInputSet, self)._set_input('AccountName', value)
    def set_Password(self, value):
        ...
        """
        super(ProjectCountsInputSet, self)._set_input('Password', value)
    def set_Username(self, value):
        """
        Set the value of the Username input for this Choreo. ((required, string) Your Basecamp username or API Key.)
        """
        super(ProjectCountsInputSet, self)._set_input('Username', value)
