...
class GetPeopleWithinProject(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetPeopleWithinProject, self).__init__(temboo_session, '/Library/Basecamp/GetPeopleWithinProject')
...
class GetPeopleWithinProjectInputSet(InputSet):
    ...
    def set_AccountName(self, value):
        ...
        """
        super(GetPeopleWithinProjectInputSet, self)._set_input('AccountName', value)
    def set_Password(self, value):
        ...
        """
        super(GetPeopleWithinProjectInputSet, self)._set_input('Password', value)
    def set_ProjectId(self, value):
        ...
        """
        super(GetPeopleWithinProjectInputSet, self)._set_input('ProjectId', value)
    def set_Username(self, value):
        """
        Set the value of the Username input for this Choreo. ((required, string) Your Basecamp username or API Key.)
        """
        super(GetPeopleWithinProjectInputSet, self)._set_input('Username', value)
