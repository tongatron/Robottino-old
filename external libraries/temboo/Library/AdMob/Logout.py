...
class Logout(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(Logout, self).__init__(temboo_session, '/Library/AdMob/Logout')
