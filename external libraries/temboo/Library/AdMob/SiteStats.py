...
class SiteStats(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(SiteStats, self).__init__(temboo_session, '/Library/AdMob/SiteStats')
...
class SiteStatsInputSet(InputSet):
    ...
    def set_ClientKey(self, value):
        ...
        """
        super(SiteStatsInputSet, self)._set_input('ClientKey', value)
    def set_Email(self, value):
        ...
        """
        super(SiteStatsInputSet, self)._set_input('Email', value)
    def set_EndDate(self, value):
        ...
        """
        super(SiteStatsInputSet, self)._set_input('EndDate', value)
    def set_ObjectDimension(self, value):
        ...
        """
        super(SiteStatsInputSet, self)._set_input('ObjectDimension', value)
    def set_OrderBy(self, value):
        ...
        """
        super(SiteStatsInputSet, self)._set_input('OrderBy', value)
    def set_Password(self, value):
        ...
        """
        super(SiteStatsInputSet, self)._set_input('Password', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(SiteStatsInputSet, self)._set_input('ResponseFormat', value)
    def set_SiteID(self, value):
        """
        Set the value of the SiteID input for this Choreo. ((optional, string) Search for a site matching this ID.)
        """
        super(SiteStatsInputSet, self)._set_input('SiteID', value)
    def set_StartDate(self, value):
        ...
        """
        super(SiteStatsInputSet, self)._set_input('StartDate', value)
    def set_TimeDimension(self, value):
        ...
        """
        super(SiteStatsInputSet, self)._set_input('TimeDimension', value)
    def set_Token(self, value):
        ...
        """
        super(SiteStatsInputSet, self)._set_input('Token', value)
