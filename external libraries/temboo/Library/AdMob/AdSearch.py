...
class AdSearch(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(AdSearch, self).__init__(temboo_session, '/Library/AdMob/AdSearch')
...
class AdSearchInputSet(InputSet):
    ...
    def set_ClientKey(self, value):
        ...
        """
        super(AdSearchInputSet, self)._set_input('ClientKey', value)
    def set_Email(self, value):
        ...
        """
        super(AdSearchInputSet, self)._set_input('Email', value)
    def set_IncludeDeleted(self, value):
        ...
        """
        super(AdSearchInputSet, self)._set_input('IncludeDeleted', value)
    def set_Password(self, value):
        ...
        """
        super(AdSearchInputSet, self)._set_input('Password', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(AdSearchInputSet, self)._set_input('ResponseFormat', value)
    def set_Token(self, value):
        ...
        """
        super(AdSearchInputSet, self)._set_input('Token', value)
