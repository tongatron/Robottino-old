...
class ShowEvent(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ShowEvent, self).__init__(temboo_session, '/Library/OneLogin/Events/ShowEvent')
