...
class CreateEvent(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CreateEvent, self).__init__(temboo_session, '/Library/OneLogin/Events/CreateEvent')
...
class CreateEventInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(CreateEventInputSet, self)._set_input('APIKey', value)
    def set_EventTypeID(self, value):
        ...
        """
        super(CreateEventInputSet, self)._set_input('EventTypeID', value)
    def set_ObjectID(self, value):
        ...
        """
        super(CreateEventInputSet, self)._set_input('ObjectID', value)
    def set_ObjectName(self, value):
        ...
        """
        super(CreateEventInputSet, self)._set_input('ObjectName', value)
