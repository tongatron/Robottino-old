...
class ShowGroup(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ShowGroup, self).__init__(temboo_session, '/Library/OneLogin/Groups/ShowGroup')
