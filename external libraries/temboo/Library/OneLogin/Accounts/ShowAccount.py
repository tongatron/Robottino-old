...
class ShowAccount(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ShowAccount, self).__init__(temboo_session, '/Library/OneLogin/Accounts/ShowAccount')
...
class ShowAccountInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ShowAccountInputSet, self)._set_input('APIKey', value)
    def set_ID(self, value):
        """
        Set the value of the ID input for this Choreo. ((required, integer) The id the account you want to return.)
        """
        super(ShowAccountInputSet, self)._set_input('ID', value)
