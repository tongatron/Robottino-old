...
class ShowRole(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ShowRole, self).__init__(temboo_session, '/Library/OneLogin/Roles/ShowRole')
