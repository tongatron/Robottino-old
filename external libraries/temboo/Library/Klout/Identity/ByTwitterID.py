...
class ByTwitterID(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ByTwitterID, self).__init__(temboo_session, '/Library/Klout/Identity/ByTwitterID')
...
class ByTwitterIDInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ByTwitterIDInputSet, self)._set_input('APIKey', value)
    def set_TwitterID(self, value):
        ...
        """
        super(ByTwitterIDInputSet, self)._set_input('TwitterID', value)
