...
class ByTwitterScreenName(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ByTwitterScreenName, self).__init__(temboo_session, '/Library/Klout/Identity/ByTwitterScreenName')
...
class ByTwitterScreenNameInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ByTwitterScreenNameInputSet, self)._set_input('APIKey', value)
    def set_ScreenName(self, value):
        ...
        """
        super(ByTwitterScreenNameInputSet, self)._set_input('ScreenName', value)
