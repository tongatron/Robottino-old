...
class Influence(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(Influence, self).__init__(temboo_session, '/Library/Klout/User/Influence')
...
class InfluenceInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(InfluenceInputSet, self)._set_input('APIKey', value)
    def set_KloutID(self, value):
        ...
        """
        super(InfluenceInputSet, self)._set_input('KloutID', value)
