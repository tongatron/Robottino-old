...
class GetListingsPercentiles(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetListingsPercentiles, self).__init__(temboo_session, '/Library/NYTimes/RealEstate/GetListingsPercentiles')
...
class GetListingsPercentilesInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(GetListingsPercentilesInputSet, self)._set_input('APIKey', value)
    def set_Bedrooms(self, value):
        ...
        """
        super(GetListingsPercentilesInputSet, self)._set_input('Bedrooms', value)
    def set_DateRange(self, value):
        ...
        """
        super(GetListingsPercentilesInputSet, self)._set_input('DateRange', value)
    def set_GeoExtentLevel(self, value):
        ...
        """
        super(GetListingsPercentilesInputSet, self)._set_input('GeoExtentLevel', value)
    def set_GeoExtentValue(self, value):
        ...
        """
        super(GetListingsPercentilesInputSet, self)._set_input('GeoExtentValue', value)
    def set_GeoSummaryLevel(self, value):
        ...
        """
        super(GetListingsPercentilesInputSet, self)._set_input('GeoSummaryLevel', value)
    def set_Percentile(self, value):
        ...
        """
        super(GetListingsPercentilesInputSet, self)._set_input('Percentile', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: json (the default) and xml.)
        """
        super(GetListingsPercentilesInputSet, self)._set_input('ResponseFormat', value)
