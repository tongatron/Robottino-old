...
class GetMostEmailed(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetMostEmailed, self).__init__(temboo_session, '/Library/NYTimes/MostPopular/GetMostEmailed')
...
class GetMostEmailedInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(GetMostEmailedInputSet, self)._set_input('APIKey', value)
    def set_Offset(self, value):
        ...
        """
        super(GetMostEmailedInputSet, self)._set_input('Offset', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: json (the default) and xml.)
        """
        super(GetMostEmailedInputSet, self)._set_input('ResponseFormat', value)
    def set_Section(self, value):
        ...
        """
        super(GetMostEmailedInputSet, self)._set_input('Section', value)
    def set_TimePeriod(self, value):
        ...
        """
        super(GetMostEmailedInputSet, self)._set_input('TimePeriod', value)
