...
class CandidateDetails(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CandidateDetails, self).__init__(temboo_session, '/Library/NYTimes/CampaignFinance/Candidates/CandidateDetails')
...
class CandidateDetailsInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(CandidateDetailsInputSet, self)._set_input('APIKey', value)
    def set_CampaignCycle(self, value):
        ...
        """
        super(CandidateDetailsInputSet, self)._set_input('CampaignCycle', value)
    def set_FECID(self, value):
        ...
        """
        super(CandidateDetailsInputSet, self)._set_input('FECID', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) Enter json or xml.  Default is json.)
        """
        super(CandidateDetailsInputSet, self)._set_input('ResponseFormat', value)
