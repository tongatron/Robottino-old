...
class ContributionsToPresidentialCandidates(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ContributionsToPresidentialCandidates, self).__init__(temboo_session, '/Library/NYTimes/CampaignFinance/IndividualContributors/ContributionsToPresidentialCandidates')
...
class ContributionsToPresidentialCandidatesInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ContributionsToPresidentialCandidatesInputSet, self)._set_input('APIKey', value)
    def set_CampaignCycle(self, value):
        ...
        """
        super(ContributionsToPresidentialCandidatesInputSet, self)._set_input('CampaignCycle', value)
    def set_CandidateFECID(self, value):
        ...
        """
        super(ContributionsToPresidentialCandidatesInputSet, self)._set_input('CandidateFECID', value)
    def set_LastName(self, value):
        ...
        """
        super(ContributionsToPresidentialCandidatesInputSet, self)._set_input('LastName', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) Enter json or xml.  Default is json.)
        """
        super(ContributionsToPresidentialCandidatesInputSet, self)._set_input('ResponseFormat', value)
