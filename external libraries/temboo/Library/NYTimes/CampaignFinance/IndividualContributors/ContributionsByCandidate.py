...
class ContributionsByCandidate(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ContributionsByCandidate, self).__init__(temboo_session, '/Library/NYTimes/CampaignFinance/IndividualContributors/ContributionsByCandidate')
...
class ContributionsByCandidateInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ContributionsByCandidateInputSet, self)._set_input('APIKey', value)
    def set_CampaignCycle(self, value):
        ...
        """
        super(ContributionsByCandidateInputSet, self)._set_input('CampaignCycle', value)
    def set_CandidateFECID(self, value):
        ...
        """
        super(ContributionsByCandidateInputSet, self)._set_input('CandidateFECID', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) Enter json or xml.  Default is json.)
        """
        super(ContributionsByCandidateInputSet, self)._set_input('ResponseFormat', value)
