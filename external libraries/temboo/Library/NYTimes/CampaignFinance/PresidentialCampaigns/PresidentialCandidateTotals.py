...
class PresidentialCandidateTotals(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(PresidentialCandidateTotals, self).__init__(temboo_session, '/Library/NYTimes/CampaignFinance/PresidentialCampaigns/PresidentialCandidateTotals')
...
class PresidentialCandidateTotalsInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(PresidentialCandidateTotalsInputSet, self)._set_input('APIKey', value)
    def set_CampaignCycle(self, value):
        ...
        """
        super(PresidentialCandidateTotalsInputSet, self)._set_input('CampaignCycle', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) Enter json or xml.  Default is json.)
        """
        super(PresidentialCandidateTotalsInputSet, self)._set_input('ResponseFormat', value)
