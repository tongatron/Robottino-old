...
class CommitteeSearch(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CommitteeSearch, self).__init__(temboo_session, '/Library/NYTimes/CampaignFinance/Committees/CommitteeSearch')
...
class CommitteeSearchInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(CommitteeSearchInputSet, self)._set_input('APIKey', value)
    def set_CampaignCycle(self, value):
        ...
        """
        super(CommitteeSearchInputSet, self)._set_input('CampaignCycle', value)
    def set_Name(self, value):
        ...
        """
        super(CommitteeSearchInputSet, self)._set_input('Name', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) Enter json or xml.  Default is json.)
        """
        super(CommitteeSearchInputSet, self)._set_input('ResponseFormat', value)
