...
class LeadershipPACs(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(LeadershipPACs, self).__init__(temboo_session, '/Library/NYTimes/CampaignFinance/Committees/LeadershipPACs')
...
class LeadershipPACsInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(LeadershipPACsInputSet, self)._set_input('APIKey', value)
    def set_CampaignCycle(self, value):
        ...
        """
        super(LeadershipPACsInputSet, self)._set_input('CampaignCycle', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) Enter json or xml.  Default is json.)
        """
        super(LeadershipPACsInputSet, self)._set_input('ResponseFormat', value)
