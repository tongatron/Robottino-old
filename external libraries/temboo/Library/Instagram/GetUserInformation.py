...
class GetUserInformation(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetUserInformation, self).__init__(temboo_session, '/Library/Instagram/GetUserInformation')
...
class GetUserInformationInputSet(InputSet):
    ...
    def set_UserID(self, value):
        ...
        """
        super(GetUserInformationInputSet, self)._set_input('UserID', value)
