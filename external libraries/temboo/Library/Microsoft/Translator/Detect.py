...
class Detect(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(Detect, self).__init__(temboo_session, '/Library/Microsoft/Translator/Detect')


    def new_input_set(self):
        return DetectInputSet()

    def _make_result_set(self, result, path):
        return DetectResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return DetectChoreographyExecution(session, exec_id, path)

class DetectInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(DetectInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(DetectInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(DetectInputSet, self)._set_input('ClientSecret', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: json (the default) and xml.)
        """
        super(DetectInputSet, self)._set_input('ResponseFormat', value)
    def set_Text(self, value):
        ...
        """
        super(DetectInputSet, self)._set_input('Text', value)

class DetectResultSet(ResultSet):
    """
...
class DetectChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return DetectResultSet(response, path)
