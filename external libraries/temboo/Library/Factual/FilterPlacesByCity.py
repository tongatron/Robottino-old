...
class FilterPlacesByCity(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(FilterPlacesByCity, self).__init__(temboo_session, '/Library/Factual/FilterPlacesByCity')
...
class FilterPlacesByCityInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(FilterPlacesByCityInputSet, self)._set_input('APIKey', value)
