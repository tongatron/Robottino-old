...
class RetrieveDraftPosts(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(RetrieveDraftPosts, self).__init__(temboo_session, '/Library/Tumblr/Post/RetrieveDraftPosts')
...
class RetrieveDraftPostsInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(RetrieveDraftPostsInputSet, self)._set_input('APIKey', value)
    def set_AccessTokenSecret(self, value):
        """
        Set the value of the AccessTokenSecret input for this Choreo. ((required, string) The Access Token Secret retrieved during the OAuth process.)
        """
        super(RetrieveDraftPostsInputSet, self)._set_input('AccessTokenSecret', value)
    def set_AccessToken(self, value):
        """
        Set the value of the AccessToken input for this Choreo. ((required, string) The Access Token retrieved during the OAuth process.)
        """
        super(RetrieveDraftPostsInputSet, self)._set_input('AccessToken', value)
    def set_BaseHostname(self, value):
        ...
        """
        super(RetrieveDraftPostsInputSet, self)._set_input('BaseHostname', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.)
        """
        super(RetrieveDraftPostsInputSet, self)._set_input('ResponseFormat', value)
    def set_SecretKey(self, value):
        ...
        """
        super(RetrieveDraftPostsInputSet, self)._set_input('SecretKey', value)
