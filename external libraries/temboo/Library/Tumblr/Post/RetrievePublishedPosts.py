...
class RetrievePublishedPosts(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(RetrievePublishedPosts, self).__init__(temboo_session, '/Library/Tumblr/Post/RetrievePublishedPosts')
...
class RetrievePublishedPostsInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(RetrievePublishedPostsInputSet, self)._set_input('APIKey', value)
    def set_BaseHostname(self, value):
        ...
        """
        super(RetrievePublishedPostsInputSet, self)._set_input('BaseHostname', value)
    def set_Format(self, value):
        ...
        """
        super(RetrievePublishedPostsInputSet, self)._set_input('Format', value)
    def set_ID(self, value):
        ...
        """
        super(RetrievePublishedPostsInputSet, self)._set_input('ID', value)
    def set_Limit(self, value):
        """
        Set the value of the Limit input for this Choreo. ((optional, integer) The number of posts to return: 1- 20. Defaults to 20.)
        """
        super(RetrievePublishedPostsInputSet, self)._set_input('Limit', value)
    def set_NotesInfo(self, value):
        ...
        """
        super(RetrievePublishedPostsInputSet, self)._set_input('NotesInfo', value)
    def set_Offset(self, value):
        """
        Set the value of the Offset input for this Choreo. ((optional, integer) The post number to start at. Defaults to 0.)
        """
        super(RetrievePublishedPostsInputSet, self)._set_input('Offset', value)
    def set_ReblogInfo(self, value):
        ...
        """
        super(RetrievePublishedPostsInputSet, self)._set_input('ReblogInfo', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.)
        """
        super(RetrievePublishedPostsInputSet, self)._set_input('ResponseFormat', value)
    def set_Tag(self, value):
        """
        Set the value of the Tag input for this Choreo. ((optional, string) Limits the response to posts with the specified tag.)
        """
        super(RetrievePublishedPostsInputSet, self)._set_input('Tag', value)
    def set_Type(self, value):
        ...
        """
        super(RetrievePublishedPostsInputSet, self)._set_input('Type', value)
