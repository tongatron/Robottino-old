...
class CreatePhotoPostWithImageFile(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CreatePhotoPostWithImageFile, self).__init__(temboo_session, '/Library/Tumblr/Post/CreatePhotoPostWithImageFile')
...
class CreatePhotoPostWithImageFileInputSet(InputSet):
    ...
    def set_Data(self, value):
        ...
        """
        super(CreatePhotoPostWithImageFileInputSet, self)._set_input('Data', value)
    def set_APIKey(self, value):
        ...
        """
        super(CreatePhotoPostWithImageFileInputSet, self)._set_input('APIKey', value)
    def set_AccessTokenSecret(self, value):
        """
        Set the value of the AccessTokenSecret input for this Choreo. ((required, string) The Access Token Secret retrieved during the OAuth process.)
        """
        super(CreatePhotoPostWithImageFileInputSet, self)._set_input('AccessTokenSecret', value)
    def set_AccessToken(self, value):
        """
        Set the value of the AccessToken input for this Choreo. ((required, string) The Access Token retrieved during the OAuth process.)
        """
        super(CreatePhotoPostWithImageFileInputSet, self)._set_input('AccessToken', value)
    def set_BaseHostname(self, value):
        ...
        """
        super(CreatePhotoPostWithImageFileInputSet, self)._set_input('BaseHostname', value)
    def set_Caption(self, value):
        """
        Set the value of the Caption input for this Choreo. ((optional, string) The user-supplied caption. HTML is allowed.)
        """
        super(CreatePhotoPostWithImageFileInputSet, self)._set_input('Caption', value)
    def set_Date(self, value):
        ...
        """
        super(CreatePhotoPostWithImageFileInputSet, self)._set_input('Date', value)
    def set_Link(self, value):
        """
        Set the value of the Link input for this Choreo. ((optional, string) The "click-through URL" for the photo.)
        """
        super(CreatePhotoPostWithImageFileInputSet, self)._set_input('Link', value)
    def set_Markdown(self, value):
        ...
        """
        super(CreatePhotoPostWithImageFileInputSet, self)._set_input('Markdown', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.)
        """
        super(CreatePhotoPostWithImageFileInputSet, self)._set_input('ResponseFormat', value)
    def set_SecretKey(self, value):
        ...
        """
        super(CreatePhotoPostWithImageFileInputSet, self)._set_input('SecretKey', value)
    def set_Slug(self, value):
        """
        Set the value of the Slug input for this Choreo. ((optional, string) Adds a short text summary to the end of the post URL.)
        """
        super(CreatePhotoPostWithImageFileInputSet, self)._set_input('Slug', value)
    def set_State(self, value):
        ...
        """
        super(CreatePhotoPostWithImageFileInputSet, self)._set_input('State', value)
    def set_Tags(self, value):
        """
        Set the value of the Tags input for this Choreo. ((optional, string) Comma-separated tags for this post.)
        """
        super(CreatePhotoPostWithImageFileInputSet, self)._set_input('Tags', value)
    def set_Tweet(self, value):
        ...
        """
        super(CreatePhotoPostWithImageFileInputSet, self)._set_input('Tweet', value)
