...
class GetChangeSignatures(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetChangeSignatures, self).__init__(temboo_session, '/Library/Delicious/GetChangeSignatures')
...
class GetChangeSignaturesInputSet(InputSet):
    ...
    def set_Password(self, value):
        ...
        """
        super(GetChangeSignaturesInputSet, self)._set_input('Password', value)
    def set_Username(self, value):
        """
        Set the value of the Username input for this Choreo. ((required, string) A valid Delicious account username.)
        """
        super(GetChangeSignaturesInputSet, self)._set_input('Username', value)
