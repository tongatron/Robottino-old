...
class DeleteTag(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteTag, self).__init__(temboo_session, '/Library/Delicious/DeleteTag')
