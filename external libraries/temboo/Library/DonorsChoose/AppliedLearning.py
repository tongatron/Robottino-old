...
class AppliedLearning(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(AppliedLearning, self).__init__(temboo_session, '/Library/DonorsChoose/AppliedLearning')
...
class AppliedLearningInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(AppliedLearningInputSet, self)._set_input('APIKey', value)
    def set_Index(self, value):
        ...
        """
        super(AppliedLearningInputSet, self)._set_input('Index', value)
    def set_Max(self, value):
        ...
        """
        super(AppliedLearningInputSet, self)._set_input('Max', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(AppliedLearningInputSet, self)._set_input('ResponseFormat', value)
    def set_ShowCounts(self, value):
        ...
        """
        super(AppliedLearningInputSet, self)._set_input('ShowCounts', value)
    def set_ShowSynopsis(self, value):
        ...
        """
        super(AppliedLearningInputSet, self)._set_input('ShowSynopsis', value)
    def set_Subject(self, value):
        ...
        """
        super(AppliedLearningInputSet, self)._set_input('Subject', value)
