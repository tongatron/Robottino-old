...
class HistoryAndCivics(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(HistoryAndCivics, self).__init__(temboo_session, '/Library/DonorsChoose/HistoryAndCivics')
...
class HistoryAndCivicsInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(HistoryAndCivicsInputSet, self)._set_input('APIKey', value)
    def set_Index(self, value):
        ...
        """
        super(HistoryAndCivicsInputSet, self)._set_input('Index', value)
    def set_Max(self, value):
        ...
        """
        super(HistoryAndCivicsInputSet, self)._set_input('Max', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(HistoryAndCivicsInputSet, self)._set_input('ResponseFormat', value)
    def set_ShowCounts(self, value):
        ...
        """
        super(HistoryAndCivicsInputSet, self)._set_input('ShowCounts', value)
    def set_ShowSynopsis(self, value):
        ...
        """
        super(HistoryAndCivicsInputSet, self)._set_input('ShowSynopsis', value)
    def set_Subject(self, value):
        ...
        """
        super(HistoryAndCivicsInputSet, self)._set_input('Subject', value)
