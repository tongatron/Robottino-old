...
class ListGuideCategoriesByID(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListGuideCategoriesByID, self).__init__(temboo_session, '/Library/YouTube/GuideCategories/ListGuideCategoriesByID')
...
class ListGuideCategoriesByIDInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ListGuideCategoriesByIDInputSet, self)._set_input('APIKey', value)
    def set_AccessToken(self, value):
        ...
        """
        super(ListGuideCategoriesByIDInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(ListGuideCategoriesByIDInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(ListGuideCategoriesByIDInputSet, self)._set_input('ClientSecret', value)
    def set_Fields(self, value):
        ...
        """
        super(ListGuideCategoriesByIDInputSet, self)._set_input('Fields', value)
    def set_GuideCategoryID(self, value):
        ...
        """
        super(ListGuideCategoriesByIDInputSet, self)._set_input('GuideCategoryID', value)
    def set_H1(self, value):
        ...
        """
        super(ListGuideCategoriesByIDInputSet, self)._set_input('H1', value)
    def set_Part(self, value):
        ...
        """
        super(ListGuideCategoriesByIDInputSet, self)._set_input('Part', value)
    def set_RefreshToken(self, value):
        ...
        """
        super(ListGuideCategoriesByIDInputSet, self)._set_input('RefreshToken', value)
