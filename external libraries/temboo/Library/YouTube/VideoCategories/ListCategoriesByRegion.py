...
class ListCategoriesByRegion(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListCategoriesByRegion, self).__init__(temboo_session, '/Library/YouTube/VideoCategories/ListCategoriesByRegion')
...
class ListCategoriesByRegionInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ListCategoriesByRegionInputSet, self)._set_input('APIKey', value)
    def set_AccessToken(self, value):
        ...
        """
        super(ListCategoriesByRegionInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(ListCategoriesByRegionInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(ListCategoriesByRegionInputSet, self)._set_input('ClientSecret', value)
    def set_Fields(self, value):
        ...
        """
        super(ListCategoriesByRegionInputSet, self)._set_input('Fields', value)
    def set_H1(self, value):
        ...
        """
        super(ListCategoriesByRegionInputSet, self)._set_input('H1', value)
    def set_Part(self, value):
        ...
        """
        super(ListCategoriesByRegionInputSet, self)._set_input('Part', value)
    def set_RefreshToken(self, value):
        ...
        """
        super(ListCategoriesByRegionInputSet, self)._set_input('RefreshToken', value)
    def set_RegionCode(self, value):
        ...
        """
        super(ListCategoriesByRegionInputSet, self)._set_input('RegionCode', value)
