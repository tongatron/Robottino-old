...
class InsertPlaylist(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(InsertPlaylist, self).__init__(temboo_session, '/Library/YouTube/Playlists/InsertPlaylist')
...
class InsertPlaylistInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(InsertPlaylistInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(InsertPlaylistInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(InsertPlaylistInputSet, self)._set_input('ClientSecret', value)
    def set_Description(self, value):
        """
        Set the value of the Description input for this Choreo. ((optional, string) The playlist's description.)
        """
        super(InsertPlaylistInputSet, self)._set_input('Description', value)
    def set_Fields(self, value):
        ...
        """
        super(InsertPlaylistInputSet, self)._set_input('Fields', value)
    def set_Part(self, value):
        ...
        """
        super(InsertPlaylistInputSet, self)._set_input('Part', value)
    def set_PrivacyStatus(self, value):
        ...
        """
        super(InsertPlaylistInputSet, self)._set_input('PrivacyStatus', value)
    def set_RefreshToken(self, value):
        ...
        """
        super(InsertPlaylistInputSet, self)._set_input('RefreshToken', value)
    def set_Title(self, value):
        """
        Set the value of the Title input for this Choreo. ((required, string) The title of the playlist.)
        """
        super(InsertPlaylistInputSet, self)._set_input('Title', value)
