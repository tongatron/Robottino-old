...
class ListPlaylistsByChannel(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListPlaylistsByChannel, self).__init__(temboo_session, '/Library/YouTube/Playlists/ListPlaylistsByChannel')
...
class ListPlaylistsByChannelInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ListPlaylistsByChannelInputSet, self)._set_input('APIKey', value)
    def set_AccessToken(self, value):
        """
        Set the value of the AccessToken input for this Choreo. ((optional, string) A valid access token retrieved during the OAuth2 process. This is required unless you provide the ClientID, ClientSecret, and RefreshToken to generate a new access token.)
        """
        super(ListPlaylistsByChannelInputSet, self)._set_input('AccessToken', value)
    def set_ChannelID(self, value):
        ...
        """
        super(ListPlaylistsByChannelInputSet, self)._set_input('ChannelID', value)
    def set_ClientID(self, value):
        """
        Set the value of the ClientID input for this Choreo. ((conditional, string) The Client ID provided by Google. Required unless providing a valid AccessToken.)
        """
        super(ListPlaylistsByChannelInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        """
        Set the value of the ClientSecret input for this Choreo. ((conditional, string) The Client Secret provided by Google. Required unless providing a valid AccessToken.)
        """
        super(ListPlaylistsByChannelInputSet, self)._set_input('ClientSecret', value)
    def set_Fields(self, value):
        ...
        """
        super(ListPlaylistsByChannelInputSet, self)._set_input('Fields', value)
    def set_MaxResults(self, value):
        """
        Set the value of the MaxResults input for this Choreo. ((optional, integer) The maximum number of results to return.)
        """
        super(ListPlaylistsByChannelInputSet, self)._set_input('MaxResults', value)
    def set_PageToken(self, value):
        """
        Set the value of the PageToken input for this Choreo. ((optional, string) The "nextPageToken" found in the response which is used to page through results.)
        """
        super(ListPlaylistsByChannelInputSet, self)._set_input('PageToken', value)
    def set_Part(self, value):
        ...
        """
        super(ListPlaylistsByChannelInputSet, self)._set_input('Part', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth refresh token used to generate a new access token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(ListPlaylistsByChannelInputSet, self)._set_input('RefreshToken', value)
