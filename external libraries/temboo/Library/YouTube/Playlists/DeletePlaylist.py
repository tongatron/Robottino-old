...
class DeletePlaylist(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeletePlaylist, self).__init__(temboo_session, '/Library/YouTube/Playlists/DeletePlaylist')
...
class DeletePlaylistInputSet(InputSet):
    ...
    def set_ClientID(self, value):
        ...
        """
        super(DeletePlaylistInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(DeletePlaylistInputSet, self)._set_input('ClientSecret', value)
    def set_PlaylistID(self, value):
        ...
        """
        super(DeletePlaylistInputSet, self)._set_input('PlaylistID', value)
    def set_RefreshToken(self, value):
        ...
        """
        super(DeletePlaylistInputSet, self)._set_input('RefreshToken', value)
