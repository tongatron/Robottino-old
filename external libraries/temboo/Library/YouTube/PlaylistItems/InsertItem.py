...
class InsertItem(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(InsertItem, self).__init__(temboo_session, '/Library/YouTube/PlaylistItems/InsertItem')
...
class InsertItemInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(InsertItemInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(InsertItemInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(InsertItemInputSet, self)._set_input('ClientSecret', value)
    def set_Fields(self, value):
        ...
        """
        super(InsertItemInputSet, self)._set_input('Fields', value)
    def set_Part(self, value):
        ...
        """
        super(InsertItemInputSet, self)._set_input('Part', value)
    def set_PlaylistID(self, value):
        ...
        """
        super(InsertItemInputSet, self)._set_input('PlaylistID', value)
    def set_RefreshToken(self, value):
        ...
        """
        super(InsertItemInputSet, self)._set_input('RefreshToken', value)
    def set_VideoID(self, value):
        ...
        """
        super(InsertItemInputSet, self)._set_input('VideoID', value)
