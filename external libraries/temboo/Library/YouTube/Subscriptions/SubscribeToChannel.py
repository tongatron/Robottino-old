...
class SubscribeToChannel(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(SubscribeToChannel, self).__init__(temboo_session, '/Library/YouTube/Subscriptions/SubscribeToChannel')
...
class SubscribeToChannelInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(SubscribeToChannelInputSet, self)._set_input('AccessToken', value)
    def set_ChannelID(self, value):
        ...
        """
        super(SubscribeToChannelInputSet, self)._set_input('ChannelID', value)
    def set_ClientID(self, value):
        ...
        """
        super(SubscribeToChannelInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(SubscribeToChannelInputSet, self)._set_input('ClientSecret', value)
    def set_Fields(self, value):
        ...
        """
        super(SubscribeToChannelInputSet, self)._set_input('Fields', value)
    def set_Part(self, value):
        ...
        """
        super(SubscribeToChannelInputSet, self)._set_input('Part', value)
    def set_RefreshToken(self, value):
        ...
        """
        super(SubscribeToChannelInputSet, self)._set_input('RefreshToken', value)
