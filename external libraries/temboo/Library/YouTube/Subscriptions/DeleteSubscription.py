...
class DeleteSubscription(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteSubscription, self).__init__(temboo_session, '/Library/YouTube/Subscriptions/DeleteSubscription')
...
class DeleteSubscriptionInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(DeleteSubscriptionInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(DeleteSubscriptionInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(DeleteSubscriptionInputSet, self)._set_input('ClientSecret', value)
    def set_RefreshToken(self, value):
        ...
        """
        super(DeleteSubscriptionInputSet, self)._set_input('RefreshToken', value)
    def set_SubscriptionID(self, value):
        ...
        """
        super(DeleteSubscriptionInputSet, self)._set_input('SubscriptionID', value)
