...
class ListSubscriptionsByID(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListSubscriptionsByID, self).__init__(temboo_session, '/Library/YouTube/Subscriptions/ListSubscriptionsByID')
...
class ListSubscriptionsByIDInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ListSubscriptionsByIDInputSet, self)._set_input('APIKey', value)
    def set_AccessToken(self, value):
        ...
        """
        super(ListSubscriptionsByIDInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(ListSubscriptionsByIDInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(ListSubscriptionsByIDInputSet, self)._set_input('ClientSecret', value)
    def set_Fields(self, value):
        ...
        """
        super(ListSubscriptionsByIDInputSet, self)._set_input('Fields', value)
    def set_ForChannelId(self, value):
        ...
        """
        super(ListSubscriptionsByIDInputSet, self)._set_input('ForChannelId', value)
    def set_MaxResults(self, value):
        """
        Set the value of the MaxResults input for this Choreo. ((optional, integer) The maximum number of results to return.)
        """
        super(ListSubscriptionsByIDInputSet, self)._set_input('MaxResults', value)
    def set_Order(self, value):
        ...
        """
        super(ListSubscriptionsByIDInputSet, self)._set_input('Order', value)
    def set_PageToken(self, value):
        """
        Set the value of the PageToken input for this Choreo. ((optional, string) The "nextPageToken" found in the response which is used to page through results.)
        """
        super(ListSubscriptionsByIDInputSet, self)._set_input('PageToken', value)
    def set_Part(self, value):
        ...
        """
        super(ListSubscriptionsByIDInputSet, self)._set_input('Part', value)
    def set_RefreshToken(self, value):
        ...
        """
        super(ListSubscriptionsByIDInputSet, self)._set_input('RefreshToken', value)
    def set_SubscriptionID(self, value):
        ...
        """
        super(ListSubscriptionsByIDInputSet, self)._set_input('SubscriptionID', value)
