...
class ValidateAddress(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ValidateAddress, self).__init__(temboo_session, '/Library/USPS/AddressInformationAPI/ValidateAddress')
...
class ValidateAddressInputSet(InputSet):
    ...
    def set_AptOrSuite(self, value):
        ...
        """
        super(ValidateAddressInputSet, self)._set_input('AptOrSuite', value)
    def set_City(self, value):
        ...
        """
        super(ValidateAddressInputSet, self)._set_input('City', value)
    def set_Endpoint(self, value):
        ...
        """
        super(ValidateAddressInputSet, self)._set_input('Endpoint', value)
    def set_FirmName(self, value):
        ...
        """
        super(ValidateAddressInputSet, self)._set_input('FirmName', value)
    def set_Password(self, value):
        """
        Set the value of the Password input for this Choreo. ((required, password) The password assigned by USPS)
        """
        super(ValidateAddressInputSet, self)._set_input('Password', value)
    def set_State(self, value):
        ...
        """
        super(ValidateAddressInputSet, self)._set_input('State', value)
    def set_StreetAddress(self, value):
        ...
        """
        super(ValidateAddressInputSet, self)._set_input('StreetAddress', value)
    def set_Urbanization(self, value):
        ...
        """
        super(ValidateAddressInputSet, self)._set_input('Urbanization', value)
    def set_UserId(self, value):
        """
        Set the value of the UserId input for this Choreo. ((required, string) Alphanumeric ID assigned by USPS)
        """
        super(ValidateAddressInputSet, self)._set_input('UserId', value)
    def set_Zip4DigitCode(self, value):
        ...
        """
        super(ValidateAddressInputSet, self)._set_input('Zip4DigitCode', value)
    def set_Zip(self, value):
        ...
        """
        super(ValidateAddressInputSet, self)._set_input('Zip', value)
