...
class PriorityMailServiceRequest(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(PriorityMailServiceRequest, self).__init__(temboo_session, '/Library/USPS/DeliveryInformationAPI/PriorityMailServiceRequest')
...
class PriorityMailServiceRequestInputSet(InputSet):
    ...
    def set_DestinationZip(self, value):
        ...
        """
        super(PriorityMailServiceRequestInputSet, self)._set_input('DestinationZip', value)
    def set_Endpoint(self, value):
        ...
        """
        super(PriorityMailServiceRequestInputSet, self)._set_input('Endpoint', value)
