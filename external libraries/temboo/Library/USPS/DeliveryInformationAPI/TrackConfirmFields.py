...
class TrackConfirmFields(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(TrackConfirmFields, self).__init__(temboo_session, '/Library/USPS/DeliveryInformationAPI/TrackConfirmFields')
...
class TrackConfirmFieldsInputSet(InputSet):
    ...
    def set_Endpoint(self, value):
        ...
        """
        super(TrackConfirmFieldsInputSet, self)._set_input('Endpoint', value)
    def set_Password(self, value):
        """
        Set the value of the Password input for this Choreo. ((required, password) The password assigned by USPS)
        """
        super(TrackConfirmFieldsInputSet, self)._set_input('Password', value)
    def set_TrackID(self, value):
        ...
        """
        super(TrackConfirmFieldsInputSet, self)._set_input('TrackID', value)
    def set_UserId(self, value):
        """
        Set the value of the UserId input for this Choreo. ((required, string) Alphanumeric ID assigned by USPS)
        """
        super(TrackConfirmFieldsInputSet, self)._set_input('UserId', value)
