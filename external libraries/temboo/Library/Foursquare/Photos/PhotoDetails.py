...
class PhotoDetails(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(PhotoDetails, self).__init__(temboo_session, '/Library/Foursquare/Photos/PhotoDetails')
...
class PhotoDetailsInputSet(InputSet):
    ...
    def set_OauthToken(self, value):
        ...
        """
        super(PhotoDetailsInputSet, self)._set_input('OauthToken', value)
    def set_PhotoID(self, value):
        """
        Set the value of the PhotoID input for this Choreo. ((required, string) The ID of the photo to get details for.)
        """
        super(PhotoDetailsInputSet, self)._set_input('PhotoID', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that response should be in. Can be set to xml or json. Defaults to json.)
        """
        super(PhotoDetailsInputSet, self)._set_input('ResponseFormat', value)
