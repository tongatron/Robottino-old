...
class VenueDetail(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(VenueDetail, self).__init__(temboo_session, '/Library/Foursquare/Venues/VenueDetail')
...
class VenueDetailInputSet(InputSet):
    ...
    def set_ClientID(self, value):
        ...
        """
        super(VenueDetailInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(VenueDetailInputSet, self)._set_input('ClientSecret', value)
    def set_OauthToken(self, value):
        ...
        """
        super(VenueDetailInputSet, self)._set_input('OauthToken', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that response should be in. Can be set to xml or json. Defaults to json.)
        """
        super(VenueDetailInputSet, self)._set_input('ResponseFormat', value)
    def set_VenueID(self, value):
        ...
        """
        super(VenueDetailInputSet, self)._set_input('VenueID', value)
