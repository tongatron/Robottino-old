...
class ApproveFriendRequest(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ApproveFriendRequest, self).__init__(temboo_session, '/Library/Foursquare/Users/ApproveFriendRequest')
...
class ApproveFriendRequestInputSet(InputSet):
    ...
    def set_OauthToken(self, value):
        ...
        """
        super(ApproveFriendRequestInputSet, self)._set_input('OauthToken', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that response should be in. Can be set to xml or json. Defaults to json.)
        """
        super(ApproveFriendRequestInputSet, self)._set_input('ResponseFormat', value)
    def set_UserID(self, value):
        """
        Set the value of the UserID input for this Choreo. ((required, string) The user ID of a pending friend.)
        """
        super(ApproveFriendRequestInputSet, self)._set_input('UserID', value)
