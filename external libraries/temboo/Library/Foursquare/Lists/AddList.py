...
class AddList(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(AddList, self).__init__(temboo_session, '/Library/Foursquare/Lists/AddList')
...
class AddListInputSet(InputSet):
    ...
    def set_PhotoID(self, value):
        ...
        """
        super(AddListInputSet, self)._set_input('PhotoID', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that response should be in. Can be set to xml or json. Defaults to json.)
        """
        super(AddListInputSet, self)._set_input('ResponseFormat', value)
