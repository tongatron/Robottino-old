...
class DistrictSearch(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DistrictSearch, self).__init__(temboo_session, '/Library/SchoolFinder/DistrictSearch')
...
class DistrictSearchInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(DistrictSearchInputSet, self)._set_input('APIKey', value)
    def set_City(self, value):
        ...
        """
        super(DistrictSearchInputSet, self)._set_input('City', value)
    def set_DistrictID(self, value):
        ...
        """
        super(DistrictSearchInputSet, self)._set_input('DistrictID', value)
    def set_DistrictLEA(self, value):
        ...
        """
        super(DistrictSearchInputSet, self)._set_input('DistrictLEA', value)
    def set_DistrictName(self, value):
        ...
        """
        super(DistrictSearchInputSet, self)._set_input('DistrictName', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(DistrictSearchInputSet, self)._set_input('ResponseFormat', value)
    def set_State(self, value):
        ...
        """
        super(DistrictSearchInputSet, self)._set_input('State', value)
