...
class RetrieveRecords(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(RetrieveRecords, self).__init__(temboo_session, '/Library/RunKeeper/PersonalRecords/RetrieveRecords')
...
class RetrieveRecordsInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(RetrieveRecordsInputSet, self)._set_input('AccessToken', value)
