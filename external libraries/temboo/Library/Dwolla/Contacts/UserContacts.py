...
class UserContacts(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(UserContacts, self).__init__(temboo_session, '/Library/Dwolla/Contacts/UserContacts')
...
class UserContactsInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(UserContactsInputSet, self)._set_input('AccessToken', value)
    def set_Limit(self, value):
        ...
        """
        super(UserContactsInputSet, self)._set_input('Limit', value)
    def set_Search(self, value):
        ...
        """
        super(UserContactsInputSet, self)._set_input('Search', value)
    def set_Types(self, value):
        ...
        """
        super(UserContactsInputSet, self)._set_input('Types', value)
