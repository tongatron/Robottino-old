...
class GetAliasesByEntity(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetAliasesByEntity, self).__init__(temboo_session, '/Library/LittleSis/Entity/GetAliasesByEntity')
...
class GetAliasesByEntityInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(GetAliasesByEntityInputSet, self)._set_input('APIKey', value)
    def set_EntityID(self, value):
        ...
        """
        super(GetAliasesByEntityInputSet, self)._set_input('EntityID', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(GetAliasesByEntityInputSet, self)._set_input('ResponseFormat', value)
