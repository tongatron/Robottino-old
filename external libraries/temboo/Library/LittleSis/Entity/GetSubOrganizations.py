...
class GetSubOrganizations(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetSubOrganizations, self).__init__(temboo_session, '/Library/LittleSis/Entity/GetSubOrganizations')
...
class GetSubOrganizationsInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(GetSubOrganizationsInputSet, self)._set_input('APIKey', value)
    def set_EntityID(self, value):
        """
        Set the value of the EntityID input for this Choreo. ((required, integer) The ID of the organization.)
        """
        super(GetSubOrganizationsInputSet, self)._set_input('EntityID', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(GetSubOrganizationsInputSet, self)._set_input('ResponseFormat', value)
