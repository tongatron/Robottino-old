...
class GetLeadershipByPerson(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetLeadershipByPerson, self).__init__(temboo_session, '/Library/LittleSis/Entity/GetLeadershipByPerson')
...
class GetLeadershipByPersonInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(GetLeadershipByPersonInputSet, self)._set_input('APIKey', value)
    def set_Current(self, value):
        ...
        """
        super(GetLeadershipByPersonInputSet, self)._set_input('Current', value)
    def set_EntityID(self, value):
        """
        Set the value of the EntityID input for this Choreo. ((required, integer) The ID of the person.)
        """
        super(GetLeadershipByPersonInputSet, self)._set_input('EntityID', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(GetLeadershipByPersonInputSet, self)._set_input('ResponseFormat', value)
    def set_Type(self, value):
        ...
        """
        super(GetLeadershipByPersonInputSet, self)._set_input('Type', value)
