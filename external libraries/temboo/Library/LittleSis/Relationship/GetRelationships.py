...
class GetRelationships(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetRelationships, self).__init__(temboo_session, '/Library/LittleSis/Relationship/GetRelationships')
...
class GetRelationshipsInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(GetRelationshipsInputSet, self)._set_input('APIKey', value)
    def set_Details(self, value):
        ...
        """
        super(GetRelationshipsInputSet, self)._set_input('Details', value)
    def set_RelationshipID(self, value):
        ...
        """
        super(GetRelationshipsInputSet, self)._set_input('RelationshipID', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(GetRelationshipsInputSet, self)._set_input('ResponseFormat', value)
