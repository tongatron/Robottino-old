...
class ListSearchByKeyword(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListSearchByKeyword, self).__init__(temboo_session, '/Library/LittleSis/List/ListSearchByKeyword')
...
class ListSearchByKeywordInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ListSearchByKeywordInputSet, self)._set_input('APIKey', value)
    def set_Keywords(self, value):
        """
        Set the value of the Keywords input for this Choreo. ((required, string) Enter search text.)
        """
        super(ListSearchByKeywordInputSet, self)._set_input('Keywords', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(ListSearchByKeywordInputSet, self)._set_input('ResponseFormat', value)
