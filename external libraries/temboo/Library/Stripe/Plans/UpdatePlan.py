...
class UpdatePlan(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(UpdatePlan, self).__init__(temboo_session, '/Library/Stripe/Plans/UpdatePlan')
...
class UpdatePlanInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(UpdatePlanInputSet, self)._set_input('APIKey', value)
    def set_PlanID(self, value):
        ...
        """
        super(UpdatePlanInputSet, self)._set_input('PlanID', value)
    def set_PlanName(self, value):
        ...
        """
        super(UpdatePlanInputSet, self)._set_input('PlanName', value)
