...
class CreateInvoice(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CreateInvoice, self).__init__(temboo_session, '/Library/Stripe/Invoices/CreateInvoice')
...
class CreateInvoiceInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(CreateInvoiceInputSet, self)._set_input('APIKey', value)
    def set_CustomerID(self, value):
        ...
        """
        super(CreateInvoiceInputSet, self)._set_input('CustomerID', value)
