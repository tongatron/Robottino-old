...
class CreateCoupon(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CreateCoupon, self).__init__(temboo_session, '/Library/Stripe/Coupons/CreateCoupon')
...
class CreateCouponInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(CreateCouponInputSet, self)._set_input('APIKey', value)
    def set_CouponID(self, value):
        ...
        """
        super(CreateCouponInputSet, self)._set_input('CouponID', value)
    def set_DurationInMonths(self, value):
        ...
        """
        super(CreateCouponInputSet, self)._set_input('DurationInMonths', value)
    def set_Duration(self, value):
        ...
        """
        super(CreateCouponInputSet, self)._set_input('Duration', value)
    def set_MaxRedemptions(self, value):
        ...
        """
        super(CreateCouponInputSet, self)._set_input('MaxRedemptions', value)
    def set_PercentOff(self, value):
        ...
        """
        super(CreateCouponInputSet, self)._set_input('PercentOff', value)
    def set_RedeemBy(self, value):
        ...
        """
        super(CreateCouponInputSet, self)._set_input('RedeemBy', value)
