...
class HourlyUVByCity(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(HourlyUVByCity, self).__init__(temboo_session, '/Library/EnviroFacts/UVForecast/HourlyUVByCity')
...
class HourlyUVByCityInputSet(InputSet):
    ...
    def set_City(self, value):
        ...
        """
        super(HourlyUVByCityInputSet, self)._set_input('City', value)
    def set_ResponseType(self, value):
        ...
        """
        super(HourlyUVByCityInputSet, self)._set_input('ResponseType', value)
    def set_State(self, value):
        ...
        """
        super(HourlyUVByCityInputSet, self)._set_input('State', value)
