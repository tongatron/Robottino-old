...
class SearchByProduct(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(SearchByProduct, self).__init__(temboo_session, '/Library/EnviroFacts/DesignForEnvironment/SearchByProduct')
...
class SearchByProductInputSet(InputSet):
    ...
    def set_CompanyKeyword(self, value):
        ...
        """
        super(SearchByProductInputSet, self)._set_input('CompanyKeyword', value)
    def set_Operator(self, value):
        ...
        """
        super(SearchByProductInputSet, self)._set_input('Operator', value)
    def set_ProductID(self, value):
        ...
        """
        super(SearchByProductInputSet, self)._set_input('ProductID', value)
    def set_ProductKeyword(self, value):
        ...
        """
        super(SearchByProductInputSet, self)._set_input('ProductKeyword', value)
    def set_ResponseFormat(self, value):
        ...
        """
        super(SearchByProductInputSet, self)._set_input('ResponseFormat', value)
    def set_RowEnd(self, value):
        ...
        """
        super(SearchByProductInputSet, self)._set_input('RowEnd', value)
    def set_RowStart(self, value):
        ...
        """
        super(SearchByProductInputSet, self)._set_input('RowStart', value)
