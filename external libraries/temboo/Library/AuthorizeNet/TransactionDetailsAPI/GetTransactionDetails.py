...
class GetTransactionDetails(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetTransactionDetails, self).__init__(temboo_session, '/Library/AuthorizeNet/TransactionDetailsAPI/GetTransactionDetails')
...
class GetTransactionDetailsInputSet(InputSet):
    ...
    def set_APILoginId(self, value):
        ...
        """
        super(GetTransactionDetailsInputSet, self)._set_input('APILoginId', value)
    def set_Endpoint(self, value):
        ...
        """
        super(GetTransactionDetailsInputSet, self)._set_input('Endpoint', value)
    ...
    def set_TransactionKey(self, value):
        ...
        """
        super(GetTransactionDetailsInputSet, self)._set_input('TransactionKey', value)
