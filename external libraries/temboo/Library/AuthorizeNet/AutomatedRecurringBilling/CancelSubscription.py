...
class CancelSubscription(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CancelSubscription, self).__init__(temboo_session, '/Library/AuthorizeNet/AutomatedRecurringBilling/CancelSubscription')
...
class CancelSubscriptionInputSet(InputSet):
    ...
    def set_APILoginId(self, value):
        ...
        """
        super(CancelSubscriptionInputSet, self)._set_input('APILoginId', value)
    def set_Endpoint(self, value):
        ...
        """
        super(CancelSubscriptionInputSet, self)._set_input('Endpoint', value)
    def set_RefId(self, value):
        ...
        """
        super(CancelSubscriptionInputSet, self)._set_input('RefId', value)
    def set_SubscriptionId(self, value):
        ...
        """
        super(CancelSubscriptionInputSet, self)._set_input('SubscriptionId', value)
    def set_TransactionKey(self, value):
        ...
        """
        super(CancelSubscriptionInputSet, self)._set_input('TransactionKey', value)
