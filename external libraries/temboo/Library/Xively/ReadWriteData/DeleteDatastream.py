...
class DeleteDatastream(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteDatastream, self).__init__(temboo_session, '/Library/Xively/ReadWriteData/DeleteDatastream')
...
class DeleteDatastreamInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(DeleteDatastreamInputSet, self)._set_input('APIKey', value)
    def set_DatastreamID(self, value):
        ...
        """
        super(DeleteDatastreamInputSet, self)._set_input('DatastreamID', value)
    def set_FeedID(self, value):
        ...
        """
        super(DeleteDatastreamInputSet, self)._set_input('FeedID', value)
