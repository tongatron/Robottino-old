...
class ListAllTriggers(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListAllTriggers, self).__init__(temboo_session, '/Library/Xively/Triggers/ListAllTriggers')
...
class ListAllTriggersInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ListAllTriggersInputSet, self)._set_input('APIKey', value)
    def set_FeedID(self, value):
        ...
        """
        super(ListAllTriggersInputSet, self)._set_input('FeedID', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are "json" (the default) and "xml".)
        """
        super(ListAllTriggersInputSet, self)._set_input('ResponseFormat', value)
