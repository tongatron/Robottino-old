...
class CreateDevice(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CreateDevice, self).__init__(temboo_session, '/Library/Xively/Devices/CreateDevice')
...
class CreateDeviceInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(CreateDeviceInputSet, self)._set_input('APIKey', value)
    def set_ProductID(self, value):
        ...
        """
        super(CreateDeviceInputSet, self)._set_input('ProductID', value)
    def set_SerialNumbers(self, value):
        ...
        """
        super(CreateDeviceInputSet, self)._set_input('SerialNumbers', value)
