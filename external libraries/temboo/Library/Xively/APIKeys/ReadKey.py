...
class ReadKey(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ReadKey, self).__init__(temboo_session, '/Library/Xively/APIKeys/ReadKey')
...
class ReadKeyInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ReadKeyInputSet, self)._set_input('APIKey', value)
    def set_MasterAPIKey(self, value):
        ...
        """
        super(ReadKeyInputSet, self)._set_input('MasterAPIKey', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are "json" (the default) and "xml".)
        """
        super(ReadKeyInputSet, self)._set_input('ResponseFormat', value)
