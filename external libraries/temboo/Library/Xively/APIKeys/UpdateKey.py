...
class UpdateKey(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(UpdateKey, self).__init__(temboo_session, '/Library/Xively/APIKeys/UpdateKey')
...
class UpdateKeyInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(UpdateKeyInputSet, self)._set_input('APIKey', value)
    def set_AccessMethods(self, value):
        ...
        """
        super(UpdateKeyInputSet, self)._set_input('AccessMethods', value)
    def set_CustomKey(self, value):
        ...
        """
        super(UpdateKeyInputSet, self)._set_input('CustomKey', value)
    def set_CustomPermissions(self, value):
        ...
        """
        super(UpdateKeyInputSet, self)._set_input('CustomPermissions', value)
    def set_CustomType(self, value):
        ...
        """
        super(UpdateKeyInputSet, self)._set_input('CustomType', value)
    def set_Label(self, value):
        ...
        """
        super(UpdateKeyInputSet, self)._set_input('Label', value)
    def set_MasterAPIKey(self, value):
        ...
        """
        super(UpdateKeyInputSet, self)._set_input('MasterAPIKey', value)
    def set_PrivateAccess(self, value):
        ...
        """
        super(UpdateKeyInputSet, self)._set_input('PrivateAccess', value)
    def set_ResourceFeedID(self, value):
        ...
        """
        super(UpdateKeyInputSet, self)._set_input('ResourceFeedID', value)
    def set_SourceIP(self, value):
        ...
        """
        super(UpdateKeyInputSet, self)._set_input('SourceIP', value)
