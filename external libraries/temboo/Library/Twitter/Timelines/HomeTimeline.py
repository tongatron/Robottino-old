...
class HomeTimeline(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(HomeTimeline, self).__init__(temboo_session, '/Library/Twitter/Timelines/HomeTimeline')
...
class HomeTimelineInputSet(InputSet):
    ...
    def set_AccessTokenSecret(self, value):
        ...
        """
        super(HomeTimelineInputSet, self)._set_input('AccessTokenSecret', value)
    def set_AccessToken(self, value):
        """
        Set the value of the AccessToken input for this Choreo. ((required, string) The Access Token provided by Twitter or retrieved during the OAuth process.)
        """
        super(HomeTimelineInputSet, self)._set_input('AccessToken', value)
    def set_ConsumerKey(self, value):
        """
        Set the value of the ConsumerKey input for this Choreo. ((required, string) The Consumer Key provided by Twitter.)
        """
        super(HomeTimelineInputSet, self)._set_input('ConsumerKey', value)
    def set_ConsumerSecret(self, value):
        """
        Set the value of the ConsumerSecret input for this Choreo. ((required, string) The Consumer Secret provided by Twitter.)
        """
        super(HomeTimelineInputSet, self)._set_input('ConsumerSecret', value)
    def set_ContributorDetails(self, value):
        ...
        """
        super(HomeTimelineInputSet, self)._set_input('ContributorDetails', value)
    def set_Count(self, value):
        ...
        """
        super(HomeTimelineInputSet, self)._set_input('Count', value)
    def set_ExcludeReplies(self, value):
        ...
        """
        super(HomeTimelineInputSet, self)._set_input('ExcludeReplies', value)
    def set_IncludeEntities(self, value):
        ...
        """
        super(HomeTimelineInputSet, self)._set_input('IncludeEntities', value)
    def set_MaxId(self, value):
        ...
        """
        super(HomeTimelineInputSet, self)._set_input('MaxId', value)
    def set_SinceId(self, value):
        ...
        """
        super(HomeTimelineInputSet, self)._set_input('SinceId', value)
    def set_TrimUser(self, value):
        ...
        """
        super(HomeTimelineInputSet, self)._set_input('TrimUser', value)
