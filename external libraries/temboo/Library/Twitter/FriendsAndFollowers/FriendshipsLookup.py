...
class FriendshipsLookup(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(FriendshipsLookup, self).__init__(temboo_session, '/Library/Twitter/FriendsAndFollowers/FriendshipsLookup')
...
class FriendshipsLookupInputSet(InputSet):
    ...
    def set_AccessTokenSecret(self, value):
        ...
        """
        super(FriendshipsLookupInputSet, self)._set_input('AccessTokenSecret', value)
    def set_AccessToken(self, value):
        """
        Set the value of the AccessToken input for this Choreo. ((required, string) The Access Token provided by Twitter or retrieved during the OAuth process.)
        """
        super(FriendshipsLookupInputSet, self)._set_input('AccessToken', value)
    def set_ConsumerKey(self, value):
        """
        Set the value of the ConsumerKey input for this Choreo. ((required, string) The Consumer Key provided by Twitter.)
        """
        super(FriendshipsLookupInputSet, self)._set_input('ConsumerKey', value)
    def set_ConsumerSecret(self, value):
        """
        Set the value of the ConsumerSecret input for this Choreo. ((required, string) The Consumer Secret provided by Twitter.)
        """
        super(FriendshipsLookupInputSet, self)._set_input('ConsumerSecret', value)
    def set_ScreenName(self, value):
        ...
        """
        super(FriendshipsLookupInputSet, self)._set_input('ScreenName', value)
    def set_UserID(self, value):
        ...
        """
        super(FriendshipsLookupInputSet, self)._set_input('UserID', value)
