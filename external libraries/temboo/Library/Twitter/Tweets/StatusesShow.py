...
class StatusesShow(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(StatusesShow, self).__init__(temboo_session, '/Library/Twitter/Tweets/StatusesShow')
...
class StatusesShowInputSet(InputSet):
    ...
    def set_AccessTokenSecret(self, value):
        ...
        """
        super(StatusesShowInputSet, self)._set_input('AccessTokenSecret', value)
    def set_AccessToken(self, value):
        """
        Set the value of the AccessToken input for this Choreo. ((required, string) The Access Token provided by Twitter or retrieved during the OAuth process.)
        """
        super(StatusesShowInputSet, self)._set_input('AccessToken', value)
    def set_ConsumerKey(self, value):
        """
        Set the value of the ConsumerKey input for this Choreo. ((required, string) The Consumer Key provided by Twitter.)
        """
        super(StatusesShowInputSet, self)._set_input('ConsumerKey', value)
    def set_ConsumerSecret(self, value):
        """
        Set the value of the ConsumerSecret input for this Choreo. ((required, string) The Consumer Secret provided by Twitter.)
        """
        super(StatusesShowInputSet, self)._set_input('ConsumerSecret', value)
    def set_ID(self, value):
        """
        Set the value of the ID input for this Choreo. ((required, string) The numerical ID of the desired Tweet.)
        """
        super(StatusesShowInputSet, self)._set_input('ID', value)
    def set_IncludeEntities(self, value):
        ...
        """
        super(StatusesShowInputSet, self)._set_input('IncludeEntities', value)
    def set_IncludeMyRetweet(self, value):
        ...
        """
        super(StatusesShowInputSet, self)._set_input('IncludeMyRetweet', value)
    def set_TrimUser(self, value):
        ...
        """
        super(StatusesShowInputSet, self)._set_input('TrimUser', value)
