...
class ShowList(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ShowList, self).__init__(temboo_session, '/Library/Twitter/Lists/ShowList')
...
class ShowListInputSet(InputSet):
    ...
    def set_AccessTokenSecret(self, value):
        ...
        """
        super(ShowListInputSet, self)._set_input('AccessTokenSecret', value)
    def set_AccessToken(self, value):
        """
        Set the value of the AccessToken input for this Choreo. ((required, string) The Access Token provided by Twitter or retrieved during the OAuth process.)
        """
        super(ShowListInputSet, self)._set_input('AccessToken', value)
    def set_ConsumerKey(self, value):
        """
        Set the value of the ConsumerKey input for this Choreo. ((required, string) The Consumer Key provided by Twitter.)
        """
        super(ShowListInputSet, self)._set_input('ConsumerKey', value)
    def set_ConsumerSecret(self, value):
        """
        Set the value of the ConsumerSecret input for this Choreo. ((required, string) The Consumer Secret provided by Twitter.)
        """
        super(ShowListInputSet, self)._set_input('ConsumerSecret', value)
    def set_ListId(self, value):
        ...
        """
        super(ShowListInputSet, self)._set_input('ListId', value)
    def set_OwnerId(self, value):
        ...
        """
        super(ShowListInputSet, self)._set_input('OwnerId', value)
    def set_OwnerScreenName(self, value):
        ...
        """
        super(ShowListInputSet, self)._set_input('OwnerScreenName', value)
    def set_Slug(self, value):
        ...
        """
        super(ShowListInputSet, self)._set_input('Slug', value)
