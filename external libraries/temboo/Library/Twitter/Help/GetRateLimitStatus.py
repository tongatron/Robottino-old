...
class GetRateLimitStatus(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetRateLimitStatus, self).__init__(temboo_session, '/Library/Twitter/Help/GetRateLimitStatus')
...
class GetRateLimitStatusInputSet(InputSet):
    ...
    def set_AccessTokenSecret(self, value):
        ...
        """
        super(GetRateLimitStatusInputSet, self)._set_input('AccessTokenSecret', value)
    def set_AccessToken(self, value):
        """
        Set the value of the AccessToken input for this Choreo. ((required, string) The Access Token provided by Twitter or retrieved during the OAuth process.)
        """
        super(GetRateLimitStatusInputSet, self)._set_input('AccessToken', value)
    def set_ConsumerKey(self, value):
        """
        Set the value of the ConsumerKey input for this Choreo. ((required, string) The Consumer Key provided by Twitter.)
        """
        super(GetRateLimitStatusInputSet, self)._set_input('ConsumerKey', value)
    def set_ConsumerSecret(self, value):
        """
        Set the value of the ConsumerSecret input for this Choreo. ((required, string) The Consumer Secret provided by Twitter.)
        """
        super(GetRateLimitStatusInputSet, self)._set_input('ConsumerSecret', value)
    def set_Resources(self, value):
        ...
        """
        super(GetRateLimitStatusInputSet, self)._set_input('Resources', value)
