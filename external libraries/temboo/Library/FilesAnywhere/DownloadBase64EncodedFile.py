...
class DownloadBase64EncodedFile(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DownloadBase64EncodedFile, self).__init__(temboo_session, '/Library/FilesAnywhere/DownloadBase64EncodedFile')
...
class DownloadBase64EncodedFileInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(DownloadBase64EncodedFileInputSet, self)._set_input('APIKey', value)
    def set_OrgID(self, value):
        ...
        """
        super(DownloadBase64EncodedFileInputSet, self)._set_input('OrgID', value)
    def set_Password(self, value):
        ...
        """
        super(DownloadBase64EncodedFileInputSet, self)._set_input('Password', value)
    def set_Path(self, value):
        ...
        """
        super(DownloadBase64EncodedFileInputSet, self)._set_input('Path', value)
    def set_Token(self, value):
        ...
        """
        super(DownloadBase64EncodedFileInputSet, self)._set_input('Token', value)
    def set_Username(self, value):
        ...
        """
        super(DownloadBase64EncodedFileInputSet, self)._set_input('Username', value)
