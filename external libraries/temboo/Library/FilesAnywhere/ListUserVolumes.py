...
class ListUserVolumes(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListUserVolumes, self).__init__(temboo_session, '/Library/FilesAnywhere/ListUserVolumes')
...
class ListUserVolumesInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ListUserVolumesInputSet, self)._set_input('APIKey', value)
    def set_OrgID(self, value):
        ...
        """
        super(ListUserVolumesInputSet, self)._set_input('OrgID', value)
    def set_Password(self, value):
        ...
        """
        super(ListUserVolumesInputSet, self)._set_input('Password', value)
    def set_Token(self, value):
        ...
        """
        super(ListUserVolumesInputSet, self)._set_input('Token', value)
    def set_Username(self, value):
        ...
        """
        super(ListUserVolumesInputSet, self)._set_input('Username', value)
