...
class GetLoadServingEntity(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetLoadServingEntity, self).__init__(temboo_session, '/Library/Genability/TariffData/GetLoadServingEntity')
...
class GetLoadServingEntityInputSet(InputSet):
    ...
    def set_AppID(self, value):
        ...
        """
        super(GetLoadServingEntityInputSet, self)._set_input('AppID', value)
    def set_AppKey(self, value):
        """
        Set the value of the AppKey input for this Choreo. ((required, string) The App Key provided by Genability.)
        """
        super(GetLoadServingEntityInputSet, self)._set_input('AppKey', value)
    def set_LSEID(self, value):
        ...
        """
        super(GetLoadServingEntityInputSet, self)._set_input('LSEID', value)
