...
class GetPropertyKeys(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetPropertyKeys, self).__init__(temboo_session, '/Library/Genability/TariffData/GetPropertyKeys')
...
class GetPropertyKeysInputSet(InputSet):
    ...
    def set_AppID(self, value):
        ...
        """
        super(GetPropertyKeysInputSet, self)._set_input('AppID', value)
    def set_AppKey(self, value):
        """
        Set the value of the AppKey input for this Choreo. ((required, string) The App Key provided by Genability.)
        """
        super(GetPropertyKeysInputSet, self)._set_input('AppKey', value)
    def set_EntityID(self, value):
        ...
        """
        super(GetPropertyKeysInputSet, self)._set_input('EntityID', value)
    def set_EntityType(self, value):
        ...
        """
        super(GetPropertyKeysInputSet, self)._set_input('EntityType', value)
    def set_PageCount(self, value):
        ...
        """
        super(GetPropertyKeysInputSet, self)._set_input('PageCount', value)
    def set_PageStart(self, value):
        ...
        """
        super(GetPropertyKeysInputSet, self)._set_input('PageStart', value)
