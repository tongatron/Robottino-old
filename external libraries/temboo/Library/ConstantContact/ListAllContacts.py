...
class ListAllContacts(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListAllContacts, self).__init__(temboo_session, '/Library/ConstantContact/ListAllContacts')
