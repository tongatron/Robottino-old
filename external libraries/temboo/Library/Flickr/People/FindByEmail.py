...
class FindByEmail(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(FindByEmail, self).__init__(temboo_session, '/Library/Flickr/People/FindByEmail')
...
class FindByEmailInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(FindByEmailInputSet, self)._set_input('APIKey', value)
    def set_FindEmail(self, value):
        ...
        """
        super(FindByEmailInputSet, self)._set_input('FindEmail', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: xml and json. Defaults to json.)
        """
        super(FindByEmailInputSet, self)._set_input('ResponseFormat', value)
