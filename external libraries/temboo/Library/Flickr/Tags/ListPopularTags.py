...
class ListPopularTags(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListPopularTags, self).__init__(temboo_session, '/Library/Flickr/Tags/ListPopularTags')
...
class ListPopularTagsInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ListPopularTagsInputSet, self)._set_input('APIKey', value)
    def set_APISecret(self, value):
        ...
        """
        super(ListPopularTagsInputSet, self)._set_input('APISecret', value)
    def set_AccessTokenSecret(self, value):
        ...
        """
        super(ListPopularTagsInputSet, self)._set_input('AccessTokenSecret', value)
    def set_AccessToken(self, value):
        ...
        """
        super(ListPopularTagsInputSet, self)._set_input('AccessToken', value)
    def set_Count(self, value):
        ...
        """
        super(ListPopularTagsInputSet, self)._set_input('Count', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: xml and json. Defaults to json.)
        """
        super(ListPopularTagsInputSet, self)._set_input('ResponseFormat', value)
    def set_UserID(self, value):
        ...
        """
        super(ListPopularTagsInputSet, self)._set_input('UserID', value)
