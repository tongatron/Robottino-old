...
class Authenticate(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(Authenticate, self).__init__(temboo_session, '/Library/Instapaper/Authenticate')
...
class AuthenticateInputSet(InputSet):
    ...
    def set_Password(self, value):
        ...
        """
        super(AuthenticateInputSet, self)._set_input('Password', value)
    def set_Username(self, value):
        """
        Set the value of the Username input for this Choreo. ((required, string) Your Instapaper username.)
        """
        super(AuthenticateInputSet, self)._set_input('Username', value)
