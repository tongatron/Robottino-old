...
class GetInvoice(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetInvoice, self).__init__(temboo_session, '/Library/MongoHQ/Invoices/GetInvoice')
...
class GetInvoiceInputSet(InputSet):
    ...
    def set_APIToken(self, value):
        ...
        """
        super(GetInvoiceInputSet, self)._set_input('APIToken', value)
    def set_ID(self, value):
        """
        Set the value of the ID input for this Choreo. ((required, string) The ID of the invoice to retrieve.)
        """
        super(GetInvoiceInputSet, self)._set_input('ID', value)
