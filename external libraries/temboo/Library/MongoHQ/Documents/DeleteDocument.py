...
class DeleteDocument(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DeleteDocument, self).__init__(temboo_session, '/Library/MongoHQ/Documents/DeleteDocument')
...
class DeleteDocumentInputSet(InputSet):
    ...
    def set_APIToken(self, value):
        ...
        """
        super(DeleteDocumentInputSet, self)._set_input('APIToken', value)
    def set_CollectionName(self, value):
        ...
        """
        super(DeleteDocumentInputSet, self)._set_input('CollectionName', value)
    def set_DatabaseName(self, value):
        ...
        """
        super(DeleteDocumentInputSet, self)._set_input('DatabaseName', value)
    def set_DocumentID(self, value):
        ...
        """
        super(DeleteDocumentInputSet, self)._set_input('DocumentID', value)
